...
| [`code-review`](skills/code-review/) | Independent code review for structural complexity, ownership, abstraction health, maintainability, clarity, consistency, correctness risks, and behavior-preserving refinement. |
