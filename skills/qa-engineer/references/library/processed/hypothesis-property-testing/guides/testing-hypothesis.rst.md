...
> Upstream path: `guides/testing-hypothesis.rst`  
> Upstream Git blob: `5c8e45f1ae8c33ded4d598dbcd619e0651c00428`  
...
Further reading: How [SQLite is tested](https://sqlite.org/testing.html),
[how the Space Shuttle was tested](https://www.fastcompany.com/28121/they-write-right-stuff),
[how to misuse code coverage](http://www.exampler.com/testing-com/writings/coverage.pdf)
(for inspiration, *not* implementation).
Dan Luu writes about [fuzz testing](https://danluu.com/testing/) and
[broken processes](https://danluu.com/wat/), among other things.
