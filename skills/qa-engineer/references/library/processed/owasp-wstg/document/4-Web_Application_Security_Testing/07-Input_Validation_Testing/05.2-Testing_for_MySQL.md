...
> Upstream path: `document/4-Web_Application_Security_Testing/07-Input_Validation_Testing/05.2-Testing_for_MySQL.md`  
> Upstream Git blob: `2b9ce1cd19946f121e57b25fb706d0c914bc5304`  
...
*MySQL server* has a few particularities so that some exploits need to be specially customized for this application. That's the subject of this section. Since MariaDB is a fork of MySQL, the contents of this page will also be relevant for MariaDB.
