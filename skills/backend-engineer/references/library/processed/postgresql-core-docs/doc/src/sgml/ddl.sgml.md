...
> Upstream path: `doc/src/sgml/ddl.sgml`  
> Upstream Git blob: `9006b947e74cdffd4a77f94b936b8606afc448eb`  
...
CREATE POLICY fp_s ON information FOR SELECT
  USING (group_id alice wishes to change the slightly
...
ALTER TABLE measurement_y2008m02 ADD CONSTRAINT y2008m02
   CHECK ( logdate >= DATE '2008-02-01' AND logdate ATTACH PARTITION command,
...
CHECK ( outletID >= 100 AND outletID = DATE '2006-02-01' AND logdate = DATE '2006-03-01' AND logdate = DATE '2007-11-01' AND logdate = DATE '2007-12-01' AND logdate = DATE '2008-01-01' AND logdate
...
BEGIN
    IF ( NEW.logdate >= DATE '2006-02-01' AND
         NEW.logdate = DATE '2006-03-01' AND
            NEW.logdate = DATE '2008-01-01' AND
            NEW.logdate IF test must exactly match the
...
ON INSERT TO measurement WHERE
    ( logdate >= DATE '2006-02-01' AND logdate = DATE '2008-01-01' AND logdate COPY ignores rules.  If you want to
...
```
CREATE TABLE measurement_y2008m02 (
    CHECK ( logdate >= DATE '2008-02-01' AND logdate = DATE '2008-02-01' AND logdate CHECK constraints are mutually
