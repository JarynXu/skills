...
> Upstream path: `doc/go_mem.html`  
> Upstream Git blob: `8db7d65e7342a81a6127b4519ad77d5b6fa666a5`  
...
such as those in the [`sync`](/pkg/sync/)
and [`sync/atomic`](/pkg/sync/atomic/) packages.
...
“[Foundations of the C++ Concurrency Memory Model](https://dl.acm.org/doi/10.1145/1375581.1375591)”,
...
defined as the partial order requirements set out by the [Go language specification](/ref/spec)
for Go's control flow constructs as well as the [order of evaluation for expressions](/ref/spec#Order_of_evaluation).
...
The APIs in the [`sync/atomic`](/pkg/sync/atomic/)
...
The [`runtime`](/pkg/runtime/) package provides
...
including [condition variables](/pkg/sync/#Cond),
[lock-free maps](/pkg/sync/#Map),
[allocation pools](/pkg/sync/#Pool),
and
[wait groups](/pkg/sync/#WaitGroup).
