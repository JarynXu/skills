...
> Upstream path: `docs/src/main/asciidoc/lifecycle.adoc`  
> Upstream Git blob: `b4bf56322a60650fa603ee8cd25cd94a3302c498`  
...
The solution is located in the `lifecycle-quickstart` [directory]({quickstarts-tree-url}/lifecycle-quickstart).
...
Check the [AppLifecycleBean.java]({quickstarts-blob-url}/lifecycle-quickstart/src/main/java/org/acme/lifecycle/AppLifecycleBean.java) class for details.
...
See [Three Phases of Bootstrap and Quarkus Philosophy](writing-extensions.adoc#bootstrap-three-phases) for more details.
