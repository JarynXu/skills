...
> Upstream path: `docs/src/main/asciidoc/quarkus-reactive-architecture.adoc`  
> Upstream Git blob: `de3162c125e2f246a564cb9c0693e7ce8a04e13f`  
...
4. Asynchronous message passing - the components of a reactive system interact using messages
...
[TIP]
====
Find more info about Mutiny and its usage in Quarkus on [Mutiny support documentation](mutiny-primer.adoc).
====
