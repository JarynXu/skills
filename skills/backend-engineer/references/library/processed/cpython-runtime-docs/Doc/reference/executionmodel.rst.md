...
> Upstream path: `Doc/reference/executionmodel.rst`  
> Upstream Git blob: `639c232571edf38aa7832f6aeaf2f80f4f2c9c59`  
...
A module run as a top level script (as module \_\_main\_\_) from the command
...
- :ref:`targets <assignment>` that are identifiers if occurring in
  ...
  - after :keyword:`!as` in a :keyword:`with` statement, :keyword:`except`
    clause, :keyword:`except\* <except\_star>` clause, or in the as-pattern in structural pattern matching,
...
imported. The main module for a script is always called :mod:`\_\_main\_\_`.
...
- Expressions in annotation scopes cannot contain :keyword:`yield`, yield from,
  :keyword:`await`, or :token:`:= <python-grammar:assignment\_expression>`
...
- While annotation scopes have an internal name, that name is not reflected in the
  ...
  Instead, the :attr:`~definition.\_\_qualname\_\_`
...
are only evaluated when necessary, for example when the \_\_value\_\_
attribute on a type alias is accessed.

Example:

Here the exception is raised only when the \_\_value\_\_ attribute
of the type alias or the \_\_bound\_\_ attribute of the type variable
is accessed.
...
is actually found by looking up the name \_\_builtins\_\_ in its
global namespace; this should be a dictionary or a module (in the
latter case the module's dictionary is used). By default, when in the
:mod:`\_\_main\_\_` module, \_\_builtins\_\_ is the built-in module
:mod:`builtins`; when in any other module, \_\_builtins\_\_ is an
...
enclosing namespace, but in the global namespace. [[1]](#footnote-1) The :func:`exec` and
