...
> Upstream path: `framework-docs/modules/ROOT/pages/core/expressions/language-ref/operator-safe-navigation.adoc`  
> Upstream Git blob: `2ab7a5498186fcce68af6a01e0a4f99009455b1c`  
...
* [arrays and collections](core/expressions/language-ref/properties-arrays.adoc#expressions-indexing-arrays-and-collections)
* [strings](core/expressions/language-ref/properties-arrays.adoc#expressions-indexing-strings)
* [maps](core/expressions/language-ref/properties-arrays.adoc#expressions-indexing-maps)
* [objects](core/expressions/language-ref/properties-arrays.adoc#expressions-indexing-objects)
* [custom](core/expressions/language-ref/properties-arrays.adoc#expressions-indexing-custom)
...
[collection selection](core/expressions/language-ref/collection-selection.adoc) and
[collection projection](core/expressions/language-ref/collection-projection.adoc) via
