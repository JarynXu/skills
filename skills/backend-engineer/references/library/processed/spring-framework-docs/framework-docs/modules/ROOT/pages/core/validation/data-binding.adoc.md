...
> Upstream path: `framework-docs/modules/ROOT/pages/core/validation/data-binding.adoc`  
> Upstream Git blob: `c0ca55f24185d75ac7fb968993126dacd7646760`  
...
using [Spring's MVC web framework](web/webmvc.adoc#mvc), using a `PropertyEditorRegistrar` in
