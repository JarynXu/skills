...
> Upstream path: `framework-docs/modules/ROOT/pages/data-access/jdbc/core.adoc`  
> Upstream Git blob: `e8abe1a25509dcdb13cccadccfc203566b1dd5d9`  
...
hierarchy defined in the `org.springframework.dao` package. (See [Consistent Exception Hierarchy](data-access/dao.adoc#dao-exceptions).)
...
More sophisticated stored procedure support is [covered later](data-access/jdbc/object.adoc#jdbc-StoredProcedure).
