...
> Upstream path: `framework-docs/modules/ROOT/pages/web/webflux/new-framework.adoc`  
> Upstream Git blob: `b99b3cb292fbd08f83f004881c6ed7e5ffb1f90a`  
...
of RxJava or another reactive library. See [Reactive Libraries](web/webflux-reactive-libraries.adoc) for more details.

NOTE: In addition to Reactive APIs, WebFlux can also be used with
[Coroutines](languages/kotlin/coroutines.adoc) APIs in Kotlin which provides a more imperative style of programming.
...
including HTTP abstractions, Reactive Streams [adapters](web/webflux/reactive-spring.adoc#webflux-httphandler)
for supported servers, [codecs](web/webflux/reactive-spring.adoc#webflux-codecs), and a core
[`WebHandler` API](web/webflux/reactive-spring.adoc#webflux-web-handler-api) comparable to
the Servlet API but with non-blocking contracts.

On that foundation, Spring WebFlux provides a choice of two programming models:

* [Annotated Controllers](web/webflux/controller.adoc): Consistent with Spring MVC and based on the
...
* [Functional Endpoints](web/webflux-functional.adoc): Lambda-based, lightweight,
...
You can return reactive types (Reactor, RxJava, [or other](web/webflux-reactive-libraries.adoc))
...
[common API](web/webflux/reactive-spring.adoc#webflux-httphandler) so that higher-level
...
easy to [assemble](web/webflux/reactive-spring.adoc#webflux-web-handler-api) an application from Spring configuration and
[WebFlux infrastructure](web/webflux/dispatcher-handler.adoc#webflux-framework-config) and [run it](web/webflux/reactive-spring.adoc#webflux-httphandler) with a few
lines of code.
...
[configure](web/webflux-webclient/client-builder.adoc) the `WebClient` directly.
