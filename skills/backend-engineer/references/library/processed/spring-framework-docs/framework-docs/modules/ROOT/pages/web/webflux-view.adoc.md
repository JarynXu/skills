...
> Upstream path: `framework-docs/modules/ROOT/pages/web/webflux-view.adoc`  
> Upstream Git blob: `8d34f5072edf2af568864763c5d753e5ad5aa270`  
...
[.small]#[See equivalent in the Servlet stack](web/webmvc-view.adoc)#
...
For more context on view rendering, please see [View Resolution](web/webflux/dispatcher-handler.adoc#webflux-viewresolution).
...
## Thymeleaf
[.small]#[See equivalent in the Servlet stack](web/webmvc-view/mvc-thymeleaf.adoc)#
...
## FreeMarker
[.small]#[See equivalent in the Servlet stack](web/webmvc-view/mvc-freemarker.adoc)#
...
### View Configuration
[.small]#[See equivalent in the Servlet stack](web/webmvc-view/mvc-freemarker.adoc#mvc-view-freemarker-contextconfig)#
...
[.small]#[See equivalent in the Servlet stack](web/webmvc-view/mvc-freemarker.adoc#mvc-views-freemarker)#
...
### Form Handling
[.small]#[See equivalent in the Servlet stack](web/webmvc-view/mvc-freemarker.adoc#mvc-view-freemarker-forms)#
...
#### The Bind Macros
[.small]#[See equivalent in the Servlet stack](web/webmvc-view/mvc-freemarker.adoc#mvc-view-bind-macros)#
...
For additional details on binding support, see [Simple Binding](web/webmvc-view/mvc-freemarker.adoc#mvc-view-simple-binding)
 for Spring MVC.
...
* [Input Macros](web/webmvc-view/mvc-freemarker.adoc#mvc-views-form-macros)
* [Input Fields](web/webmvc-view/mvc-freemarker.adoc#mvc-views-form-macros-input)
* [Selection Fields](web/webmvc-view/mvc-freemarker.adoc#mvc-views-form-macros-select)
* [HTML Escaping](web/webmvc-view/mvc-freemarker.adoc#mvc-views-form-macros-html-escaping)


[[webflux-view-script]]
## Script Views
[.small]#[See equivalent in the Servlet stack](web/webmvc-view/mvc-script.adoc)#
...
### Requirements
[.small]#[See equivalent in the Servlet stack](web/webmvc-view/mvc-script.adoc#mvc-view-script-dependencies)#
...
### Script Templates
[.small]#[See equivalent in the Servlet stack](web/webmvc-view/mvc-script.adoc#mvc-view-script-integrate)#
...
## HTML Fragment
[.small]#[See equivalent in the Servlet stack](web/webmvc-view/mvc-fragments.adoc)#
...
## JSON and XML
[.small]#[See equivalent in the Servlet stack](web/webmvc-view/mvc-jackson.adoc)#

For [Content Negotiation](web/webflux/dispatcher-handler.adoc#webflux-multiple-representations)
...
plug in any of the available [Codecs](web/webflux/reactive-spring.adoc#webflux-codecs) from
...
instead [configured](web/webflux/config.adoc#webflux-config-view-resolvers) as a default view.
