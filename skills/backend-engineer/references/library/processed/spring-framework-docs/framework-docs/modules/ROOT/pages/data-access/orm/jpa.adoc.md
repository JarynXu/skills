...
> Upstream path: `framework-docs/modules/ROOT/pages/data-access/orm/jpa.adoc`  
> Upstream Git blob: `4e7ebb775630a7781400b16f5d095a438fd86aab`  
...
See the [Spring configuration](core/aop/using-aspectj.adoc#aop-aj-ltw-spring) in the AOP chapter for
...
As described in [Spring configuration](core/aop/using-aspectj.adoc#aop-aj-ltw-spring), you can configure
...
NOTE: We strongly encourage you to read [Declarative Transaction Management](data-access/transaction/declarative.adoc),
...
See [Spurious Application Server Warnings with Hibernate](data-access/orm/hibernate.adoc#orm-hibernate-invalid-jdbc-access-error) for related notes.
