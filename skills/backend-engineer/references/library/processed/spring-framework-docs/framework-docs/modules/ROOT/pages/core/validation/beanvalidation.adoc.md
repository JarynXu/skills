...
> Upstream path: `framework-docs/modules/ROOT/pages/core/validation/beanvalidation.adoc`  
> Upstream Git blob: `4a810b98a70c175d0d2322bfb7132c27f429e6e2`  
...
[TIP]
====
Method validation relies on [AOP Proxies](core/aop/introduction-proxies.adoc) around the
...
[Understanding AOP Proxies](core/aop/proxying.adoc#aop-understanding-aop-proxies). In addition remember
...
[Validation](web/webmvc/mvc-controller/ann-validation.adoc) and
[Error Responses](web/webmvc/mvc-ann-rest-exceptions.adoc) sections, and the WebFlux
[Validation](web/webflux/controller/ann-validation.adoc) and
[Error Responses](web/webflux/ann-rest-exceptions.adoc) sections.
...
Properties::
+
```properties,indent=0,subs="verbatim,quotes"
...
[Spring MVC Validation Configuration](web/webmvc/mvc-config/validation.adoc).


[[validation-mvc]]
## Spring MVC Validation

See [Validation](web/webmvc/mvc-config/validation.adoc) in the Spring MVC chapter.
