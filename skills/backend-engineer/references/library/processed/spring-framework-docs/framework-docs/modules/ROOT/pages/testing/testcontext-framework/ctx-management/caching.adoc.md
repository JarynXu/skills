...
> Upstream path: `framework-docs/modules/ROOT/pages/testing/testcontext-framework/ctx-management/caching.adoc`  
> Upstream Git blob: `aa749f6b78dfa0c0e9bce694f99f9824ea6f842a`  
...
`@DirtiesContext` in
[Spring Testing Annotations](testing/annotations/integration-spring/annotation-dirtiescontext.adoc)).
...
execution of a test method according to [`@DirtiesContext`](testing/annotations/integration-spring/annotation-dirtiescontext.adoc)
