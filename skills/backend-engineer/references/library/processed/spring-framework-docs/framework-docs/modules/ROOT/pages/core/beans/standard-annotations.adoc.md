...
> Upstream path: `framework-docs/modules/ROOT/pages/core/beans/standard-annotations.adoc`  
> Upstream Git blob: `dfb9515fafec7c93487e679d1fb8da2a5b9c4c51`  
...
Java::
+
```java,indent=0,subs="verbatim,quotes",fold="-imports"
...
Kotlin::
+
```kotlin,indent=0,subs="verbatim,quotes",fold="-imports"
	import jakarta.inject.Inject
