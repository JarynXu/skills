...
> Upstream path: `framework-docs/modules/ROOT/pages/core/beans/basics.adoc`  
> Upstream Git blob: `d645e080b1d717f938a328aaec6c308018820061`  
...
[Convenient ApplicationContext Instantiation for Web Applications](core/beans/context-introduction.adoc#context-create)).
...
[Java-based configuration](core/beans/java.adoc) for their Spring applications:

* [Annotation-based configuration](core/beans/annotation-config.adoc): define beans using
  annotation-based configuration metadata on your application's component classes.
* [Java-based configuration](core/beans/java.adoc): define beans external to your application
...
[Dependencies](core/beans/dependencies.adoc) for more information.
...
as described in [Application Contexts and Resource Paths](core/resources.adoc#resources-app-ctx).
====
...
[Dependencies](core/beans/dependencies.adoc).
