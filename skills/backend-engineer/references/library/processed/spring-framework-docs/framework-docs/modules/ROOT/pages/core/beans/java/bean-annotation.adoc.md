...
> Upstream path: `framework-docs/modules/ROOT/pages/core/beans/java/bean-annotation.adoc`  
> Upstream Git blob: `ca87b4d1e14039f71be27101f557f20a6da84454`  
...
* [name](core/beans/definition.adoc#beans-beanname)
* [init-method](core/beans/factory-nature.adoc#beans-factory-lifecycle-initializingbean)
* [destroy-method](core/beans/factory-nature.adoc#beans-factory-lifecycle-disposablebean)
* [autowiring](core/beans/dependencies/factory-autowire.adoc)
...
injection. See
[the relevant section](core/beans/dependencies/factory-collaborators.adoc#beans-constructor-injection)
for more details.
...
[JSR-250 annotations](core/beans/annotation-config/postconstruct-and-predestroy-annotations.adoc) for further
details.

The regular Spring [lifecycle](core/beans/factory-nature.adoc) callbacks are fully supported as
well. If a bean implements `InitializingBean`, `DisposableBean`, or `Lifecycle`, their
respective methods are called by the container.

The standard set of `*Aware` interfaces (such as [BeanFactoryAware](core/beans/beanfactory.adoc),
[BeanNameAware](core/beans/factory-nature.adoc#beans-factory-aware),
[MessageSourceAware](core/beans/context-introduction.adoc#context-functionality-messagesource),
[ApplicationContextAware](core/beans/factory-nature.adoc#beans-factory-aware), and so on) are also fully supported.
...
[Bean Scopes](core/beans/factory-scopes.adoc) section.
...
[scoped proxies](core/beans/factory-scopes.adoc#beans-factory-scopes-other-injection). The easiest way to create
...
[scoped proxies](core/beans/factory-scopes.adoc#beans-factory-scopes-other-injection)) to our `@Bean` using Java,
...
As discussed in [Naming Beans](core/beans/definition.adoc#beans-beanname), it is
