...
> Upstream path: `framework-docs/modules/ROOT/pages/web/websocket/stomp/enable.adoc`  
> Upstream Git blob: `021093ab65bcd05ccb96a3ca7531d4203556c176`  
...
```javascript,indent=0,subs="verbatim,quotes"
...
[SockJS Fallback](web/websocket/fallback.adoc) on server-side with
...
overridden) on the server side. See [Connecting to a Broker](web/websocket/stomp/handle-broker-relay-configure.adoc)
and [Authentication](web/websocket/stomp/authentication.adoc) for more information on authentication.
