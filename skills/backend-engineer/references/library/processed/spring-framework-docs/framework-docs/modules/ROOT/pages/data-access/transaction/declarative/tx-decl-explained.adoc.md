...
> Upstream path: `framework-docs/modules/ROOT/pages/data-access/transaction/declarative/tx-decl-explained.adoc`  
> Upstream Git blob: `eb71fd52e9d2f15d0f7b06863c563245aa9a0f34`  
...
[via AOP proxies](core/aop/proxying.adoc#aop-understanding-aop-proxies) and that the transactional
...
NOTE: Spring AOP is covered in [the AOP section](core/aop.adoc).
