...
> Upstream path: `framework-docs/modules/ROOT/pages/core/beans/annotation-config/value-annotations.adoc`  
> Upstream Git blob: `f5c85c8d8eae98157ed69c675eaaf637d66e3bc7`  
...
the [`SpringProperties`](appendix.adoc#appendix-spring-properties) mechanism).
...
When `@Value` contains a [`SpEL` expression](core/expressions.adoc) the value will be dynamically
