...
> Upstream path: `framework-docs/modules/ROOT/pages/core/beans/definition.adoc`  
> Upstream Git blob: `b09db5d95bbfca743c1af3b441bef104cdd354db`  
...
| Scope
| [Bean Scopes](core/beans/factory-scopes.adoc)

| Constructor arguments
| [Dependency Injection](core/beans/dependencies/factory-collaborators.adoc)

| Properties
| [Dependency Injection](core/beans/dependencies/factory-collaborators.adoc)

| Autowiring mode
| [Autowiring Collaborators](core/beans/dependencies/factory-autowire.adoc)

| Lazy initialization mode
| [Lazy-initialized Beans](core/beans/dependencies/factory-lazy-init.adoc)

| Initialization method
| [Initialization Callbacks](core/beans/factory-nature.adoc#beans-factory-lifecycle-initializingbean)

| Destruction method
| [Destruction Callbacks](core/beans/factory-nature.adoc#beans-factory-lifecycle-disposablebean)
|===
...
[this section](testing/testcontext-framework/bean-overriding.adoc) for more details.
...
Motivations for not supplying a name are related to using [inner beans](core/beans/dependencies/factory-properties-detailed.adoc#beans-inner-beans)
 and [autowiring collaborators](core/beans/dependencies/factory-autowire.adoc).
...
See [Using the `@Bean` Annotation](core/beans/java/bean-annotation.adoc) for details.
****
...
and [Bean Definition Inheritance](core/beans/child-bean-definitions.adoc).)
...
[Injecting Dependencies](core/beans/dependencies/factory-collaborators.adoc).
...
see [Dependencies and Configuration in Detail](core/beans/dependencies/factory-properties-detailed.adoc).
...
[`FactoryBean`](core/beans/factory-extension.adoc#beans-factory-extension-factorybean) implementation class.
