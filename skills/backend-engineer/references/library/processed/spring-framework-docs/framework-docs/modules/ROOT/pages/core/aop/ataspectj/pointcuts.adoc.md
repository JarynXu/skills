...
> Upstream path: `framework-docs/modules/ROOT/pages/core/aop/ataspectj/pointcuts.adoc`  
> Upstream Git blob: `c8e4f00cc4c1914b34ca8771174fd7348d7ed17a`  
...
class, consider the use of Spring-driven [native AspectJ weaving](core/aop/using-aspectj.adoc#aop-aj-ltw) instead
...
Java::
+
```java,indent=0,subs="verbatim",chomp="-packages",fold="none"
	package com.xyz;
...
Kotlin::
+
```kotlin,indent=0,subs="verbatim",chomp="-packages",fold="none"
	package com.xyz
...
The `<aop:config>` and `<aop:advisor>` elements are discussed in [Schema-based AOP Support](core/aop/schema.adoc). The
transaction elements are discussed in [Transaction Management](data-access/transaction.adoc).
...
```
+
NOTE: `this` is more commonly used in a binding form. See the section on [Declaring Advice](core/aop/ataspectj/advice.adoc)
...
```
+
NOTE: `target` is more commonly used in a binding form. See the [Declaring Advice](core/aop/ataspectj/advice.adoc) section
...
```
+
NOTE: `args` is more commonly used in a binding form. See the [Declaring Advice](core/aop/ataspectj/advice.adoc) section
...
```
+
NOTE: You can also use `@target` in a binding form. See the [Declaring Advice](core/aop/ataspectj/advice.adoc) section for
...
```
+
NOTE: You can also use `@within` in a binding form. See the [Declaring Advice](core/aop/ataspectj/advice.adoc) section for
how to make the annotation object available in the advice body.
...
```
+
NOTE: You can also use `@annotation` in a binding form. See the [Declaring Advice](core/aop/ataspectj/advice.adoc) section
...
```
+
NOTE: You can also use `@args` in a binding form. See the [Declaring Advice](core/aop/ataspectj/advice.adoc) section
