...
> Upstream path: `framework-docs/modules/ROOT/pages/web/webmvc/mvc-uri-building.adoc`  
> Upstream Git blob: `85da18dc57a816276fc7bca52b315597d77a8cf2`  
...
[.small]#[See equivalent in the Reactive stack](web/webflux/uri-building.adoc)#
...
[`ForwardedHeaderFilter`](web/webmvc/filters.adoc#filters-forwarded-headers)
...
`X-Forwarded-*` headers, which specify the client-originated address. Consider using the
[ForwardedHeaderFilter](web/webmvc/filters.adoc#filters-forwarded-headers) to extract
