...
> Upstream path: `framework-docs/modules/ROOT/pages/core/beans/annotation-config/autowired.adoc`  
> Upstream Git blob: `706377d1dcb1986a7ff2a4f652cea466a33c1679`  
...
examples included in this section. See [here](core/beans/standard-annotations.adoc) for more details.
====
