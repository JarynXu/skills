...
> Upstream path: `framework-docs/modules/ROOT/pages/testing/testcontext-framework/support-classes.adoc`  
> Upstream Git blob: `9a051a16af03da395a120711c3dea6f03464afce`  
...
* Powerful support for link:https://docs.junit.org/current/extensions/conditional-test-execution.html[conditional
  ...
  [Spring JUnit Jupiter Testing Annotations](testing/annotations/integration-junit-jupiter.adoc)
...
* Custom composed annotations that combine annotations from Spring and JUnit Jupiter. See
  ...
  [Meta-Annotation Support for Testing](testing/annotations/integration-meta.adoc) for
  further details.
...
See [`@TestConstructor`](testing/annotations/integration-junit-jupiter.adoc#integration-testing-annotations-testconstructor)
...
[`@TestConstructor`](testing/annotations/integration-junit-jupiter.adoc#integration-testing-annotations-testconstructor)),
...
property (see
[`@SpringExtensionConfig`](testing/annotations/integration-junit-jupiter.adoc#integration-testing-annotations-springextensionconfig)).
====
...
classpath. See the
["Changing the default enclosing configuration inheritance mode"](testing/annotations/integration-junit-jupiter.adoc#integration-testing-annotations-nestedtestconfiguration)
note for details.
...
[Context Caching](testing/testcontext-framework/ctx-management/caching.adoc) for details).
Consult the list of
[supported annotations](testing/annotations/integration-junit-jupiter.adoc#integration-testing-annotations-nestedtestconfiguration)
...
[false positives](testing/testcontext-framework/tx.adoc#testcontext-tx-false-positives).
As mentioned in [JDBC Testing Support](testing/support-jdbc.adoc),
