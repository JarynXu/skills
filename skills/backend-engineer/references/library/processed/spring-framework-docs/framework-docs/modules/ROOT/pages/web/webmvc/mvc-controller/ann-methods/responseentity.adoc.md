...
> Upstream path: `framework-docs/modules/ROOT/pages/web/webmvc/mvc-controller/ann-methods/responseentity.adoc`  
> Upstream Git blob: `eb2e13731ae7bd2560e5973a1666be9f82a5c721`  
...
[.small]#[See equivalent in the Reactive stack](web/webflux/controller/ann-methods/responseentity.adoc)#

`ResponseEntity` is like [`@ResponseBody`](web/webmvc/mvc-controller/ann-methods/responsebody.adoc)
...
Spring MVC supports using a single value [reactive type](web/webmvc/mvc-ann-async.adoc#mvc-ann-async-reactive-types)
