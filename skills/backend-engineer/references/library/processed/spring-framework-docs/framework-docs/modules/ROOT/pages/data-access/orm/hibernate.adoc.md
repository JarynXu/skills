...
> Upstream path: `framework-docs/modules/ROOT/pages/data-access/orm/hibernate.adoc`  
> Upstream Git blob: `fbed4b9ddb60993d9e9622083889828e7817e585`  
...
See [Native Hibernate Setup for JPA](data-access/orm/jpa.adoc#orm-jpa-hibernate) for details.
====
...
NOTE: Before you continue, we are strongly encourage you to read [Declarative Transaction Management](data-access/transaction/declarative.adoc)
...
* Pass your Spring `JtaTransactionManager` bean to your Hibernate setup. The easiest
  ...
  `LocalSessionFactoryBean` bean (see [Hibernate Transaction Setup](data-access/transaction/strategies.adoc#transaction-strategies-hibernate)).
