...
> Upstream path: `framework-docs/modules/ROOT/pages/core/beans/java/configuration-annotation.adoc`  
> Upstream Git blob: `2e17543405b09e9a72fd87a42142c481391b03c3`  
...
[Basic Concepts: `@Bean` and `@Configuration`](core/beans/java/basic-concepts.adoc)
...
As noted earlier, [lookup method injection](core/beans/dependencies/factory-method-injection.adoc) is an
