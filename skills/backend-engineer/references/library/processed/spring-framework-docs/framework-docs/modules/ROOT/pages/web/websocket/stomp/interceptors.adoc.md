...
> Upstream path: `framework-docs/modules/ROOT/pages/web/websocket/stomp/interceptors.adoc`  
> Upstream Git blob: `1f7c794edb38cc7f42b44b55bcdd2df25d7ec8f1`  
...
[Events](web/websocket/stomp/application-context-events.adoc) provide notifications for the lifecycle
