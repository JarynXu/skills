...
> Upstream path: `framework-docs/modules/ROOT/pages/core/aop/introduction-defn.adoc`  
> Upstream Git blob: `656fb0fc2a37d2bedb6ebc34bcbe09b70372a93b`  
...
* Aspect: A modularization of a concern that cuts across multiple classes.
  ...
  (the [schema-based approach](core/aop/schema.adoc)) or regular classes annotated with the
  `@Aspect` annotation (the [@AspectJ style](core/aop/ataspectj.adoc)).
