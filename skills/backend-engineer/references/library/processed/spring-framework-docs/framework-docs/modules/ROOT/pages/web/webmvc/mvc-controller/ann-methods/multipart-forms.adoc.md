...
> Upstream path: `framework-docs/modules/ROOT/pages/web/webmvc/mvc-controller/ann-methods/multipart-forms.adoc`  
> Upstream Git blob: `c2f4386df728d5411695c0d1da44684c01396373`  
...
[.small]#[See equivalent in the Reactive stack](web/webflux/controller/ann-methods/multipart-forms.adoc)#

After a `MultipartResolver` has been [enabled](web/webmvc/mvc-servlet/multipart.adoc), the content of POST
...
[command object](web/webmvc/mvc-controller/ann-methods/modelattrib-method-args.adoc). For example, the form field
