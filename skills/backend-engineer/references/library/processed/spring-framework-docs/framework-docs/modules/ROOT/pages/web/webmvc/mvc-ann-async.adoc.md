...
> Upstream path: `framework-docs/modules/ROOT/pages/web/webmvc/mvc-ann-async.adoc`  
> Upstream Git blob: `97a4193f08e63b821e736ac026a2278aeb5a7989`  
...
## HTTP Streaming
[.small]#[See equivalent in the Reactive stack](web/webflux/reactive-spring.adoc#webflux-codecs-streaming)#
...
[`HttpMessageConverter`](integration/rest-clients.adoc#rest-message-conversion) and written to the
...
[WebSocket messaging](web/websocket.adoc) with
[SockJS fallback](web/websocket/fallback.adoc) transports (including SSE) that target
...
[Reactive Libraries](web/webflux-reactive-libraries.adoc) in the WebFlux section).
...
[STOMP over WebSocket](web/websocket/stomp.adoc) or WebSocket with [SockJS](web/websocket/fallback.adoc))
