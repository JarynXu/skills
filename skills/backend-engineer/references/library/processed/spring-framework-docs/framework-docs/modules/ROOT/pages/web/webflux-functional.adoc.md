...
> Upstream path: `framework-docs/modules/ROOT/pages/web/webflux-functional.adoc`  
> Upstream Git blob: `45e4b80a8c6357bd3b4468502ca292a91d49b817`  
...
[.small]#[See equivalent in the Servlet stack](web/webmvc-functional.adoc)#
...
the same [Reactive Core](web/webflux/reactive-spring.adoc) foundation.


[[webflux-fn-overview]]
## Overview
[.small]#[See equivalent in the Servlet stack](web/webmvc-functional.adoc#webmvc-fn-overview)#
...
through one of the built-in [server adapters](web/webflux/reactive-spring.adoc#webflux-httphandler):
...
## HandlerFunction
[.small]#[See equivalent in the Servlet stack](web/webmvc-functional.adoc#webmvc-fn-handler-functions)#
...
For more on that, see [Reactive Libraries](web/webflux-reactive-libraries.adoc).
...
A functional endpoint can use Spring's [validation facilities](web/webmvc/mvc-config/validation.adoc) to
apply validation to the request body. For example, given a custom Spring
[Validator](web/webmvc/mvc-config/validation.adoc) implementation for a `Person`:

include-code::./PersonHandler[tag=snippet,indent=0]

Handlers can also use the standard bean validation API (JSR-303) by creating and injecting
a global `Validator` instance based on `LocalValidatorFactoryBean`.
See [Spring Validation](core/validation/beanvalidation.adoc).


[[webflux-fn-router-functions]]
## `RouterFunction`
[.small]#[See equivalent in the Servlet stack](web/webmvc-functional.adoc#webmvc-fn-router-functions)#
...
[WebFlux Config](web/webflux/config.adoc#webflux-config-api-version), and then you can
...
[supported version](web/webmvc/mvc-config/api-version.adoc).
...
[[webflux-fn-running]]
## Running a Server
[.small]#[See equivalent in the Servlet stack](web/webmvc-functional.adoc#webmvc-fn-running)#
...
[HttpHandler](web/webflux/reactive-spring.adoc#webflux-httphandler) for server-specific instructions.

A more typical option, also used by Spring Boot, is to run with a
[`DispatcherHandler`](web/webflux/dispatcher-handler.adoc)-based setup through the
[WebFlux Config](web/webflux/dispatcher-handler.adoc#webflux-framework-config), which uses Spring configuration to declare the
...
configuration, [orders them](core/beans/annotation-config/autowired.adoc#beans-factory-ordered), combines them through
...
[DispatcherHandler](web/webflux/dispatcher-handler.adoc) for how to run it):
...
[.small]#[See equivalent in the Servlet stack](web/webmvc-functional.adoc#webmvc-fn-handler-filter-function)#
...
[`CorsWebFilter`](web/webflux-cors.adoc#webflux-cors-webfilter).
