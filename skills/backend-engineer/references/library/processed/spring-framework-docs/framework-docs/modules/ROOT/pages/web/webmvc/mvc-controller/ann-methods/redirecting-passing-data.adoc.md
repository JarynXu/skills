...
> Upstream path: `framework-docs/modules/ROOT/pages/web/webmvc/mvc-controller/ann-methods/redirecting-passing-data.adoc`  
> Upstream Git blob: `3361914edbf5def563b4aba36e1739e6652cd2c3`  
...
in the URL). See [Flash Attributes](web/webmvc/mvc-controller/ann-methods/flash-attributes.adoc)
