...
> Upstream path: `framework-docs/modules/ROOT/pages/web/webmvc/mvc-servlet/localeresolver.adoc`  
> Upstream Git blob: `404f58a8be3a62ebac852ea4d3b383574f75b2e1`  
...
handler mapping (see [Interception](web/webmvc/mvc-servlet/handlermapping-interceptor.adoc) for more information on handler
