...
> Upstream path: `framework-docs/modules/ROOT/pages/web/webmvc/mvc-ann-rest-exceptions.adoc`  
> Upstream Git blob: `a035248477ad5fe9e0f39a55cb468f6f8488aaaf`  
...
[.small]#[See equivalent in the Reactive stack](web/webflux/ann-rest-exceptions.adoc)#
...
[@ControllerAdvice](web/webmvc/mvc-controller/ann-advice.adoc) that handles all Spring MVC exceptions,
and any `ErrorResponseException`, and renders an error response with a body.


[[mvc-ann-rest-exceptions-render]]
## Render
[.small]#[See equivalent in the Reactive stack](web/webflux/ann-rest-exceptions.adoc#webflux-ann-rest-exceptions-render)#
...
[@ControllerAdvice](web/webmvc/mvc-controller/ann-advice.adoc) in Spring configuration. The handler
...
[MVC Config](web/webmvc/mvc-config.adoc) with a `WebMvcConfigurer`. Use that to intercept
any RFC 9457 response and take some action.


[[mvc-ann-rest-exceptions-non-standard]]
## Non-Standard Fields
[.small]#[See equivalent in the Reactive stack](web/webflux/ann-rest-exceptions.adoc#webflux-ann-rest-exceptions-non-standard)#
...
[.small]#[See equivalent in the Reactive stack](web/webflux/ann-rest-exceptions.adoc#webflux-ann-rest-exceptions-i18n)#
...
these through a [MessageSource](core/beans/context-introduction.adoc#context-functionality-messagesource)
...
[MessageSource](core/beans/context-introduction.adoc#context-functionality-messagesource)
resource bundle. See
[Customizing Validation Errors](core/validation/beanvalidation.adoc#validation-beanvalidation-spring-method-i18n)
for more details.


[[mvc-ann-rest-exceptions-client]]
## Client Handling
[.small]#[See equivalent in the Reactive stack](web/webflux/ann-rest-exceptions.adoc#webflux-ann-rest-exceptions-client)#
