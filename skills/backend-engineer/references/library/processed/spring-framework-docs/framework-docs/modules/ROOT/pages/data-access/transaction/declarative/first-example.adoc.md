...
> Upstream path: `framework-docs/modules/ROOT/pages/data-access/transaction/declarative/first-example.adoc`  
> Upstream Git blob: `633b8169c013002d461f967b54f10e92df1e1747`  
...
expression. See [the AOP section](core/aop.adoc) for more details on pointcut
...
in the `x.y.service` package. See [the AOP section](core/aop.adoc) for more details.
