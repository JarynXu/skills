...
> Upstream path: `framework-docs/modules/ROOT/pages/web/webflux/reactive-spring.adoc`  
> Upstream Git blob: `5cd7aaf1394e12bce8ba2d5a2dac80d7412cf082`  
...
The higher level [WebClient](web/webflux-webclient.adoc) used in applications
...
[[webflux-multipart]]
### Multipart Data
[.small]#[See equivalent in the Servlet stack](web/webmvc/mvc-servlet/multipart.adoc)#
...
### Forwarded Headers
[.small]#[See equivalent in the Servlet stack](web/webmvc/filters.adoc#filters-forwarded-headers)#
...
[[webflux-filters]]
## Filters
[.small]#[See equivalent in the Servlet stack](web/webmvc/filters.adoc)#
...
`WebHandler`. When using the [WebFlux Config](web/webflux/dispatcher-handler.adoc#webflux-framework-config), registering a `WebFilter` is as simple
...
### CORS
[.small]#[See equivalent in the Servlet stack](web/webmvc/filters.adoc#filters-cors)#
...
See the section on [CORS](web/webflux-cors.adoc) and the [CORS `WebFilter`](web/webflux-cors.adoc#webflux-cors-webfilter) for more details.

[[filters.url-handler]]
### URL Handler
[.small]#[See equivalent in the Servlet stack](web/webmvc/filters.adoc#filters.url-handler)#
...
## Exceptions
[.small]#[See equivalent in the Servlet stack](web/webmvc/mvc-servlet/exceptionhandlers.adoc#mvc-ann-customer-servlet-container-error-page)#
...
[WebFlux Config](web/webflux/dispatcher-handler.adoc#webflux-framework-config), registering a `WebExceptionHandler` is as simple as declaring it as a
...
| Extension of `ResponseStatusExceptionHandler` that can also determine the HTTP status
  ...
  This handler is declared in the [WebFlux Config](web/webflux/dispatcher-handler.adoc#webflux-framework-config).
...
[[webflux-codecs]]
## Codecs
[.small]#[See equivalent in the Servlet stack](web/webmvc/message-converters.adoc#message-converters)#
...
what all codecs work on. See [Data Buffers and Codecs](core/databuffer-codec.adoc) in the
...
[HTTP message codecs](web/webflux/config.adoc#webflux-config-message-codecs).
...
set all codecs, see [HTTP message codecs](web/webflux/config.adoc#webflux-config-message-codecs). On the client side, the limit for
all codecs can be changed in
[WebClient.Builder](web/webflux-webclient/client-builder.adoc#webflux-client-builder-maxinmemorysize).
...
### Streaming
[.small]#[See equivalent in the Servlet stack](web/webmvc/mvc-ann-async.adoc#mvc-ann-async-http-streaming)#
...
[Data Buffers and Codecs](core/databuffer-codec.adoc). The key point to understand is that on some
...
cases please review the information in [Data Buffers and Codecs](core/databuffer-codec.adoc),
especially the section on [Using DataBuffer](core/databuffer-codec.adoc#databuffers-using).


[[webflux-logging]]
## Logging
[.small]#[See equivalent in the Servlet stack](web/webmvc/mvc-servlet/logging.adoc)#
...
### Sensitive Data
[.small]#[See equivalent in the Servlet stack](web/webmvc/mvc-servlet/logging.adoc#mvc-logging-sensitive-data)#
