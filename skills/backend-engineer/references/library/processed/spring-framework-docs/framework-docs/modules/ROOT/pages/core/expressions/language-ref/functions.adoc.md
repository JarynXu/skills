...
> Upstream path: `framework-docs/modules/ROOT/pages/core/expressions/language-ref/functions.adoc`  
> Upstream Git blob: `00f3cb56fd35fafb6be4f26cbba52fa5595daee0`  
...
invocations, [varargs](core/expressions/language-ref/varargs.adoc) are also supported
...
[variables](core/expressions/language-ref/variables.adoc) in the evaluation context,
...
([varargs](core/expressions/language-ref/varargs.adoc)).
