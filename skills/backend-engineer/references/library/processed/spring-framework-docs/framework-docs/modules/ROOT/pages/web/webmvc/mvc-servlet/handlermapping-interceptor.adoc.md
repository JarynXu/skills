...
> Upstream path: `framework-docs/modules/ROOT/pages/web/webmvc/mvc-servlet/handlermapping-interceptor.adoc`  
> Upstream Git blob: `f153256002e53aafa774d1affb931cc96878720a`  
...
[Controller Advice](web/webmvc/mvc-controller/ann-advice.adoc) bean or configure it
directly on `RequestMappingHandlerAdapter`.

See [Interceptors](web/webmvc/mvc-config/interceptors.adoc) in the section on MVC configuration for examples of how to
