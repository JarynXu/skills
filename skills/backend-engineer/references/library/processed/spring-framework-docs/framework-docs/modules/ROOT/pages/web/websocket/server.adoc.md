...
> Upstream path: `framework-docs/modules/ROOT/pages/web/websocket/server.adoc`  
> Upstream Git blob: `462815c3ec6ef8abc5e85ef900ed857df8e18a7f`  
...
[.small]#[See equivalent in the Reactive stack](web/webflux-websocket.adoc#webflux-websocket-server)#
...
## `WebSocketHandler`
[.small]#[See equivalent in the Reactive stack](web/webflux-websocket.adoc#webflux-websocket-server-handler)#
...
in the configuration of a [`DispatcherServlet`](web/webmvc/mvc-servlet.adoc). However, Spring's
...
[STOMP](web/websocket/stomp.adoc) messaging, the application must synchronize the sending of messages
...
## WebSocket Handshake
[.small]#[See equivalent in the Reactive stack](web/webflux-websocket.adoc#webflux-websocket-server-handshake)#
...
```xml,indent=0,subs="verbatim,quotes,attributes"
...
[.small]#[See equivalent in the Reactive stack](web/webflux-websocket.adoc#webflux-websocket-server-config)#
...
[STOMP WebSocket transport](web/websocket/stomp/server-config.adoc)
properties.


[[websocket-server-allowed-origins]]
## Allowed Origins
[.small]#[See equivalent in the Reactive stack](web/webflux-websocket.adoc#webflux-websocket-server-cors)#
