...
> Upstream path: `framework-docs/modules/ROOT/pages/testing/integration.adoc`  
> Upstream Git blob: `25b37db2d28db64b45523443b7eafac51a688420`  
...
[Spring TestContext Framework](testing/testcontext-framework.adoc). The TestContext
...
* [JDBC Testing Support](testing/support-jdbc.adoc)
* [Spring TestContext Framework](testing/testcontext-framework.adoc)
* [WebTestClient](testing/webtestclient.adoc)
* [MockMvc](testing/mockmvc.adoc)
* [Testing Client Applications](testing/spring-mvc-test-client.adoc)
* [Annotations](testing/annotations.adoc)
...
See [Context Management](testing/testcontext-framework/ctx-management.adoc) and
[Context Caching](testing/testcontext-framework/ctx-management/caching.adoc) with the
...
[TestContext framework](testing/testcontext-framework/fixture-di.adoc).
...
[`@Commit`](testing/annotations.adoc) annotation.

See transaction management with the [TestContext framework](testing/testcontext-framework/tx.adoc).
...
* A `JdbcTemplate`, for executing SQL statements to query the database. You can use such
  ...
  to avoid [false positives](testing/testcontext-framework/tx.adoc#testcontext-tx-false-positives).
...
See support classes for the [TestContext framework](testing/testcontext-framework/support-classes.adoc).
