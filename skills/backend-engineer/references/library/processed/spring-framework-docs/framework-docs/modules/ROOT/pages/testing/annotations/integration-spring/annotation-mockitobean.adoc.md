...
> Upstream path: `framework-docs/modules/ROOT/pages/testing/annotations/integration-spring/annotation-mockitobean.adoc`  
> Upstream Git blob: `8191b9cf99dd37dd59be690713a44ab529a8e760`  
...
[strategy for bean overrides](testing/testcontext-framework/bean-overriding.adoc#testcontext-bean-overriding-strategy).
...
[strategy](testing/testcontext-framework/bean-overriding.adoc#testcontext-bean-overriding-strategy):
...
[`@Retryable`](core/resilience.adoc#resilience-annotations-retryable) — has no adverse
