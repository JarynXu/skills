...
> Upstream path: `framework-docs/modules/ROOT/pages/testing/unit.adoc`  
> Upstream Git blob: `b2156fe83465b5071a4f7a6243dd1767453b5690`  
...
[Bean Definition Profiles](core/beans/environment.adoc#beans-definition-profiles)
and [`PropertySource` Abstraction](core/beans/environment.adoc#beans-property-source-abstraction)).
...
framework for Spring MVC. See [MockMvc](testing/mockmvc.adoc).
...
The [WebTestClient](testing/webtestclient.adoc) builds on the mock request and response to provide support for
...
[MockMvc](testing/mockmvc.adoc) instead.
