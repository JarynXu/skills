...
> Upstream path: `framework-docs/modules/ROOT/pages/data-access/transaction/strategies.adoc`  
> Upstream Git blob: `06aeeaa375ecfd0daac8f9bbe7aaa83a03611286`  
...
[programmatically](data-access/transaction/programmatic.adoc#transaction-programmatic-ptm) from your application code. Because
...
although you can use it [programmatically](data-access/transaction/programmatic.adoc#transaction-programmatic-rtm) from your
...
* Propagation: Typically, all code within a transaction scope runs in
  ...
  about the semantics of transaction propagation in Spring, see [Transaction Propagation](data-access/transaction/declarative/tx-propagation.adoc).
...
[The JEE Schema](integration/appendix.adoc#appendix.xsd-schemas-jee).
