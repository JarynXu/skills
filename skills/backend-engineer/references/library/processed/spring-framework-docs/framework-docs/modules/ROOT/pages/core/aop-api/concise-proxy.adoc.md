...
> Upstream path: `framework-docs/modules/ROOT/pages/core/aop-api/concise-proxy.adoc`  
> Upstream Git blob: `f9d2f80de30e5ea6debe95194688c4a14ef1bc47`  
...
[previously](core/beans/child-bean-definitions.adoc), so that it may not actually ever be
