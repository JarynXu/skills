...
> Upstream path: `framework-docs/modules/ROOT/pages/core/aop-api/pointcuts.adoc`  
> Upstream Git blob: `3399fc540f1b82469c6a32af731869c0ff754fec`  
...
See the [previous chapter](core/aop.adoc) for a discussion of supported AspectJ pointcut primitives.
