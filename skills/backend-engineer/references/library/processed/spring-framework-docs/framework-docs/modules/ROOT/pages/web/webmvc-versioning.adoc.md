...
> Upstream path: `framework-docs/modules/ROOT/pages/web/webmvc-versioning.adoc`  
> Upstream Git blob: `f5fbe06d614ffdeba51efb9cb3e82cb641edec11`  
...
[.small]#[See equivalent in the Reactive stack](web/webflux-versioning.adoc)#
...
- Configure [API versioning](web/webmvc/mvc-config/api-version.adoc) in the MVC Config
- [Map requests](web/webmvc/mvc-controller/ann-requestmapping.adoc#mvc-ann-requestmapping-version)
to annotated controller methods with an API version
- [Route requests](web/webmvc-functional.adoc#api-version)
...
[HTTP Service](integration/rest-clients.adoc#rest-http-service-client) clients, as well as
for testing in MockMvc and `WebTestClient`.


[[mvc-versioning-strategy]]
## ApiVersionStrategy
[.small]#[See equivalent in the Reactive stack](web/webflux-versioning.adoc#webflux-versioning-strategy)#
...
## ApiVersionResolver
[.small]#[See equivalent in the Reactive stack](web/webflux-versioning.adoc#webflux-versioning-resolver)#
...
## ApiVersionParser
[.small]#[See equivalent in the Reactive stack](web/webflux-versioning.adoc#webflux-versioning-parser)#
...
## Validation
[.small]#[See equivalent in the Reactive stack](web/webflux-versioning.adoc#webflux-versioning-validation)#
...
[.small]#[See equivalent in the Reactive stack](web/webflux-versioning.adoc#webflux-versioning-deprecation-handler)#
...
## Request Mapping
[.small]#[See equivalent in the Reactive stack](web/webflux-versioning.adoc#webflux-versioning-mapping)#

`ApiVersionStrategy` supports the mapping of requests to annotated controller methods.
See [API Version](web/webmvc/mvc-controller/ann-requestmapping.adoc#mvc-ann-requestmapping-version)
for more details.
