...
> Upstream path: `framework-docs/modules/ROOT/pages/core/expressions/evaluation.adoc`  
> Upstream Git blob: `623d4bb9643172d82f64dcc3f35ae8a80d5dbae8`  
...
[Language Reference](core/expressions/language-ref.adoc).
...
[web data binding](web/webmvc/mvc-data-binding.adoc#mvc-data-binding-design), you
...
[Supported Spring Properties](appendix.adoc#appendix-spring-properties)).
...
[`SpringProperties`](appendix.adoc#appendix-spring-properties) mechanism) to one of the
