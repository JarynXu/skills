...
> Upstream path: `framework-docs/modules/ROOT/pages/web/websocket/stomp/user-destination.adoc`  
> Upstream Git blob: `9d22069b27bdbe2f7d3acf38b72b6377dd991420`  
...
application destination prefixes as shown in [Enable STOMP](web/websocket/stomp/enable.adoc), or otherwise the
