...
> Upstream path: `framework-docs/modules/ROOT/pages/testing/testcontext-framework/tx.adoc`  
> Upstream Git blob: `2d9cf648ee5f8e1f16e23bc947c355ebb1015f8d`  
...
[transaction propagation](data-access/transaction/declarative/tx-propagation.adoc) for details).
...
Note that [`AbstractTransactionalJUnit4SpringContextTests`](testing/testcontext-framework/support-classes.adoc#testcontext-support-classes-junit4)
 and
[`AbstractTransactionalTestNGSpringContextTests`](testing/testcontext-framework/support-classes.adoc#testcontext-support-classes-testng)
...
[annotation support](testing/annotations.adoc) section for further details.
...
used. See the [annotation support](testing/annotations.adoc) section for further
information and configuration examples. [Transaction management for `@Sql`](testing/testcontext-framework/executing-sql.adoc#testcontext-executing-sql-declaratively-tx)
