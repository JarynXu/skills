...
> Upstream path: `framework-docs/modules/ROOT/pages/core/aop/using-aspectj.adoc`  
> Upstream Git blob: `d769fe201e7e2903f3f157ffbacb6c3ff3427bf8`  
...
at the field or method level (see [Annotation-based Container Configuration](core/beans/annotation-config.adoc) for further details).
...
use @AspectJ with [Java configuration](core/beans/java.adoc). Specifically, you can use the
