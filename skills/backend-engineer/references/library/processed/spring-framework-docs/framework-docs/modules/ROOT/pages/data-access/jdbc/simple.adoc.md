...
> Upstream path: `framework-docs/modules/ROOT/pages/data-access/jdbc/simple.adoc`  
> Upstream Git blob: `304fbc36d9571189039d906c78073cd80c023379`  
...
```sql,indent=0,subs="verbatim,quotes"
...
classes (covered in [Modeling JDBC Operations as Java Objects](data-access/jdbc/object.adoc)) you can use `SqlParameter` or one of its subclasses.
...
subclasses (covered in [Understanding `SqlQuery`](data-access/jdbc/object.adoc#jdbc-SqlQuery)).
