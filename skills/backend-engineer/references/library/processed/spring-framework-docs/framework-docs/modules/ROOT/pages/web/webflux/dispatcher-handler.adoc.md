...
> Upstream path: `framework-docs/modules/ROOT/pages/web/webflux/dispatcher-handler.adoc`  
> Upstream Git blob: `a4d745b92ab3e30c3d83dff243d7895e47e76ae8`  
...
[.small]#[See equivalent in the Servlet stack](web/webmvc/mvc-servlet.adoc)#
...
[`WebHandler` API](web/webflux/reactive-spring.adoc#webflux-web-handler-api).
...
[server adapter](web/webflux/reactive-spring.adoc#webflux-httphandler).


[[webflux-special-bean-types]]
## Special Bean Types
[.small]#[See equivalent in the Servlet stack](web/webmvc/mvc-servlet/special-bean-types.adoc)#
...
[Special bean types](web/webflux/reactive-spring.adoc#webflux-web-handler-api-special-beans)
...
## WebFlux Config
[.small]#[See equivalent in the Servlet stack](web/webmvc/mvc-servlet/config.adoc)#

Applications can declare the infrastructure beans (listed under
[Web Handler API](web/webflux/reactive-spring.adoc#webflux-web-handler-api-special-beans) and
...
## Processing
[.small]#[See equivalent in the Servlet stack](web/webmvc/mvc-servlet/sequence.adoc)#
...
## Exceptions
[.small]#[See equivalent in the Servlet stack](web/webmvc/mvc-servlet/exceptionhandlers.adoc)#
...
See also [Exceptions](web/webflux/controller/ann-exceptions.adoc) in the "`Annotated Controller`" section or
[Exceptions](web/webflux/reactive-spring.adoc#webflux-exception-handler) in the WebHandler API section.


[[webflux-viewresolution]]
## View Resolution
[.small]#[See equivalent in the Servlet stack](web/webmvc/mvc-servlet/viewresolver.adoc)#
...
Web applications need to use a [View rendering library](web/webflux-view.adoc) to support this use case.

[[webflux-viewresolution-handling]]
### Handling
[.small]#[See equivalent in the Servlet stack](web/webmvc/mvc-servlet/viewresolver.adoc#mvc-viewresolver-handling)#
...
to your Spring configuration. [WebFlux Config](web/webflux/config.adoc#webflux-config-view-resolvers) provides a
dedicated configuration API for view resolution.

See [View Technologies](web/webflux-view.adoc) for more on the view technologies integrated with Spring WebFlux.

[[webflux-redirecting-redirect-prefix]]
### Redirecting
[.small]#[See equivalent in the Servlet stack](web/webmvc/mvc-servlet/viewresolver.adoc#mvc-redirecting-redirect-prefix)#
...
NOTE: [Unlike the Servlet stack](web/webmvc/mvc-servlet/viewresolver.adoc#mvc-redirecting-forward-prefix),
...
### Content Negotiation
[.small]#[See equivalent in the Servlet stack](web/webmvc/mvc-servlet/viewresolver.adoc#mvc-multiple-representations)#
...
[HttpMessageWriter](web/webflux/reactive-spring.adoc#webflux-codecs). Typically, you would configure these as default
views through the [WebFlux Configuration](web/webflux/config.adoc#webflux-config-view-resolvers). Default views are
