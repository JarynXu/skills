...
> Upstream path: `framework-docs/modules/ROOT/pages/web/webmvc/mvc-controller/ann-exceptionhandler.adoc`  
> Upstream Git blob: `49c0fed3a5d6d3f9b9636423a2b5fdec155386a1`  
...
[.small]#[See equivalent in the Reactive stack](web/webflux/controller/ann-exceptions.adoc)#

`@Controller` and [@ControllerAdvice](web/webmvc/mvc-controller/ann-advice.adoc) classes can have
...
level, [HandlerExceptionResolver](web/webmvc/mvc-servlet/exceptionhandlers.adoc) mechanism.


[[mvc-ann-exceptionhandler-media]]
## Media Type Mapping
[.small]#[See equivalent in the Reactive stack](web/webflux/controller/ann-exceptions.adoc#webflux-ann-exceptionhandler-media)#
...
## Method Arguments
[.small]#[See equivalent in the Reactive stack](web/webflux/controller/ann-exceptions.adoc#webflux-ann-exceptionhandler-args)#
...
| For access to any session attribute, in contrast to model attributes stored in the
  ...
  See [`@SessionAttribute`](web/webmvc/mvc-controller/ann-methods/sessionattribute.adoc) for more details.
...
## Return Values
[.small]#[See equivalent in the Reactive stack](web/webflux/controller/ann-exceptions.adoc#webflux-ann-exceptionhandler-return-values)#
