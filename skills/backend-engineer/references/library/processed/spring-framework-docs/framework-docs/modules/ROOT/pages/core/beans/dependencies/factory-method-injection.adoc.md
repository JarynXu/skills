...
> Upstream path: `framework-docs/modules/ROOT/pages/core/beans/dependencies/factory-method-injection.adoc`  
> Upstream Git blob: `c56e7ab2410a723ab6664fd90b07fe66e015a2ee`  
...
[singletons](core/beans/factory-scopes.adoc#beans-factory-scopes-singleton). When a
...
[make bean A aware of the container](core/beans/factory-nature.adoc#beans-factory-aware)
 by implementing the `ApplicationContextAware` interface,
and by [making a `getBean("B")` call to the container](core/beans/basics.adoc#beans-factory-client) ask for (a
...
Java::
+
```java,indent=0,subs="verbatim,quotes",chomp="-packages",fold="none"
	package fiona.apple;
...
Kotlin::
+
```kotlin,indent=0,subs="verbatim,quotes",chomp="-packages",fold="none"
	package fiona.apple
...
a [singleton](core/beans/factory-scopes.adoc#beans-factory-scopes-singleton), the same instance of the `myCommand`
...
[Scoped Beans as Dependencies](core/beans/factory-scopes.adoc#beans-factory-scopes-other-injection).
