...
> Upstream path: `framework-docs/modules/ROOT/pages/testing/testcontext-framework/ctx-management/env-profiles.adoc`  
> Upstream Git blob: `2fcd2bb94883b762117eb6605194abe11ec53d11`  
...
[`@Nested` test class configuration](testing/testcontext-framework/support-classes.adoc#testcontext-junit-jupiter-nested-test-configuration) for details.
...
Java::
+
```java,indent=0,subs="verbatim,quotes",role="primary"
...
Kotlin::
+
```kotlin,indent=0,subs="verbatim,quotes",role="secondary"
	// profiles resolved programmatically via a custom resolver that
	// allows "spring.profiles.active" to override @ActiveProfiles
	@ActiveProfiles(
			resolver = SystemPropertyOverrideActiveProfilesResolver::class,
...
Java::
+
```java,indent=0,subs="verbatim,quotes",role="primary",fold="-imports"
...
Kotlin::
+
```kotlin,indent=0,subs="verbatim,quotes",role="secondary",fold="-imports"
	import org.springframework.core.env.AbstractEnvironment
	import org.springframework.test.context.support.DefaultActiveProfilesResolver
	import org.springframework.util.StringUtils
