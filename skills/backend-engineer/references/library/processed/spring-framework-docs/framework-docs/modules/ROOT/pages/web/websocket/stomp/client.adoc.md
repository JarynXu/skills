...
> Upstream path: `framework-docs/modules/ROOT/pages/web/websocket/stomp/client.adoc`  
> Upstream Git blob: `9de2b02e429a0f117c87515ce33754faf075836f`  
...
[`SockJsClient`](web/websocket/fallback.adoc#websocket-fallback-sockjs-client).
...
when initializing the [External Broker](web/websocket/stomp/handle-broker-relay.adoc) which ensures a
