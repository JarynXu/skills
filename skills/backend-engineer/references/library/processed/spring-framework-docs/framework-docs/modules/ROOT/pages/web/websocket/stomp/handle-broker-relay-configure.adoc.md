...
> Upstream path: `framework-docs/modules/ROOT/pages/web/websocket/stomp/handle-broker-relay-configure.adoc`  
> Upstream Git blob: `39abc58399453d82543b2546037b12d8c02a9eb8`  
...
need not set those headers. They are ignored. As the [Authentication](web/websocket/stomp/authentication.adoc)
