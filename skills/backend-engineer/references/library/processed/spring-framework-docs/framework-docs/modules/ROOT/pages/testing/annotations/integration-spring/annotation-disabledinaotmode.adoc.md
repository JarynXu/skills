...
> Upstream path: `framework-docs/modules/ROOT/pages/testing/annotations/integration-spring/annotation-disabledinaotmode.adoc`  
> Upstream Git blob: `be7689d1b2698af0cfb462a5e1ba2fd388239a08`  
...
[Ahead of Time Support for Tests](testing/testcontext-framework/aot.adoc).
