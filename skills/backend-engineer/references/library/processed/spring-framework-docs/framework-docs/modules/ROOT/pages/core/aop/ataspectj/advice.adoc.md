...
> Upstream path: `framework-docs/modules/ROOT/pages/core/aop/ataspectj/advice.adoc`  
> Upstream Git blob: `cab042936f3adca9ba97d115c54279c2cf5ac917`  
...
pointcut_ or a reference to a [_named pointcut_](core/aop/ataspectj/pointcuts.adoc#aop-common-pointcuts).
...
If we use a [named pointcut](core/aop/ataspectj/pointcuts.adoc#aop-common-pointcuts), we can rewrite the preceding example
as follows:
...
```
<1> References the `publicMethod` named pointcut defined in [Combining Pointcut Expressions](core/aop/ataspectj/pointcuts.adoc#aop-pointcuts-combining).
...
```
<1> References the `inDataAccessLayer` named pointcut defined in [Sharing Named Pointcut Definitions](core/aop/ataspectj/pointcuts.adoc#aop-common-pointcuts).
