...
> Upstream path: `framework-docs/modules/ROOT/pages/data-access/orm/general.adoc`  
> Upstream Git blob: `3df3429235b37f7b774e521470691e24829cb7a3`  
...
The [Hibernate](data-access/orm/hibernate.adoc) section provides more details and also show these features and
...
JDBC, the `JdbcTemplate` class mentioned in a [previous section](data-access/jdbc/core.adoc#jdbc-JdbcTemplate)
...
For details on transaction support, see the [Transaction Management](data-access/transaction.adoc) chapter.
