...
> Upstream path: `framework-docs/modules/ROOT/pages/web/webflux-versioning.adoc`  
> Upstream Git blob: `3214ed3ba7c17cba58c4041873066e273ee8fccb`  
...
[.small]#[See equivalent in the Servlet stack](web/webmvc-versioning.adoc)#
...
- Configure [API versioning](web/webflux/config.adoc#webflux-config-api-version)
in the WebFlux Config
- [Map requests](web/webflux/controller/ann-requestmapping.adoc#webflux-ann-requestmapping-version)
to annotated controller methods with an API version
- [Route requests](web/webflux-functional.adoc#api-version)
...
## ApiVersionStrategy
[.small]#[See equivalent in the Servlet stack](web/webmvc-versioning.adoc#mvc-versioning-strategy)#
...
## ApiVersionResolver
[.small]#[See equivalent in the Servlet stack](web/webmvc-versioning.adoc#mvc-versioning-resolver)#
...
## ApiVersionParser
[.small]#[See equivalent in the Servlet stack](web/webmvc-versioning.adoc#mvc-versioning-parser)#
...
## Validation
[.small]#[See equivalent in the Servlet stack](web/webmvc-versioning.adoc#mvc-versioning-validation)#
...
[.small]#[See equivalent in the Reactive stack](web/webmvc-versioning.adoc#mvc-versioning-deprecation-handler)#
...
## Request Mapping
[.small]#[See equivalent in the Servlet stack](web/webmvc-versioning.adoc#mvc-versioning-mapping)#

`ApiVersionStrategy` supports the mapping of requests to annotated controller methods.
See [API Versions](web/webflux/controller/ann-requestmapping.adoc#webflux-ann-requestmapping-version)
for more details.
