...
> Upstream path: `framework-docs/modules/ROOT/pages/testing/annotations/integration-standard.adoc`  
> Upstream Git blob: `a25251a988c13d036473e10777537b1811dd7e48`  
...
* `@Transactional` (org.springframework.transaction.annotation)
  _with [limited attribute support](testing/testcontext-framework/tx.adoc#testcontext-tx-attribute-support)_
