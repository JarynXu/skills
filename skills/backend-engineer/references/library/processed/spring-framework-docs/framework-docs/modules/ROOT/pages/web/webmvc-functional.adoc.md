...
> Upstream path: `framework-docs/modules/ROOT/pages/web/webmvc-functional.adoc`  
> Upstream Git blob: `91caa3358ec2c9b1c110f39c2c650e4546a06fa7`  
...
[.small]#[See equivalent in the Reactive stack](web/webflux-functional.adoc)#
...
the same [DispatcherServlet](web/webmvc/mvc-servlet.adoc).


[[webmvc-fn-overview]]
## Overview
[.small]#[See equivalent in the Reactive stack](web/webflux-functional.adoc#webflux-fn-overview)#
...
## HandlerFunction
[.small]#[See equivalent in the Reactive stack](web/webflux-functional.adoc#webflux-fn-handler-functions)#
...
## `RouterFunction`
[.small]#[See equivalent in the Reactive stack](web/webflux-functional.adoc#webflux-fn-router-functions)#
...
[MVC Config](web/webmvc/mvc-config/api-version.adoc), and then you can use the
...
[[webmvc-fn-running]]
## Running a Server
[.small]#[See equivalent in the Reactive stack](web/webflux-functional.adoc#webflux-fn-running)#

You typically run router functions in a [`DispatcherHandler`](web/webmvc/mvc-servlet.adoc)-based setup through the
[MVC Config](web/webmvc/mvc-config.adoc), which uses Spring configuration to declare the
...
[.small]#[See equivalent in the Reactive stack](web/webflux-functional.adoc#webflux-fn-handler-filter-function)#
...
[`CorsFilter`](web/webmvc-cors.adoc#mvc-cors-filter).
