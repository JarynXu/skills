...
> Upstream path: `framework-docs/modules/ROOT/pages/core/beans/dependencies/factory-properties-detailed.adoc`  
> Upstream Git blob: `212f388d0a5d74320e7771cd714519bb74634ff9`  
...
As mentioned in the [previous section](core/beans/dependencies/factory-collaborators.adoc),
...
[conversion service](core/validation/convert.adoc#core-convert-ConversionService-API) is used to convert these
...
bean is a [prototype](core/beans/factory-scopes.adoc) bean, this typo and the resulting
...
element brings value is in the configuration of [AOP interceptors](core/aop-api/pfb.adoc#aop-pfb-1)
...
[relevant section](core/beans/child-bean-definitions.adoc) before continuing.
...
Spring supports extensible configuration formats [with namespaces](core/appendix/xsd-schemas.adoc),
...
[Constructor-based Dependency Injection](core/beans/dependencies/factory-collaborators.adoc#beans-constructor-injection):
...
[mechanism](core/beans/dependencies/factory-collaborators.adoc#beans-factory-ctor-arguments-resolution)
