...
> Upstream path: `framework-docs/modules/ROOT/pages/core/beans/java/composing-configuration-classes.adoc`  
> Upstream Git blob: `3bd4eaf272e1bee779790c07a09cd1ad840a80cb`  
...
[we already discussed](core/beans/java/bean-annotation.adoc#beans-java-dependencies),
...
profile has been enabled in the Spring `Environment` (see [Bean Definition Profiles](core/beans/environment.adoc#beans-definition-profiles)
for details).
