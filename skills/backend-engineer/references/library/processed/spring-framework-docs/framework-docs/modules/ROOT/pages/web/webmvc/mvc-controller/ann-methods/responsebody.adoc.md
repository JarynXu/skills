...
> Upstream path: `framework-docs/modules/ROOT/pages/web/webmvc/mvc-controller/ann-methods/responsebody.adoc`  
> Upstream Git blob: `02bfeb1f2aadf71fbeb4f641fbdc608aae70875a`  
...
[.small]#[See equivalent in the Reactive stack](web/webflux/controller/ann-methods/responsebody.adoc)#

You can use the `@ResponseBody` annotation on a method to have the return serialized
to the response body through an
[HttpMessageConverter](integration/rest-clients.adoc#rest-message-conversion).
...
See [Asynchronous Requests](web/webmvc/mvc-ann-async.adoc) and
[Reactive Types](web/webmvc/mvc-ann-async.adoc#mvc-ann-async-reactive-types) for more details.

You can use the [Message Converters](web/webmvc/mvc-config/message-converters.adoc) option
of the [MVC Config](web/webmvc/mvc-config.adoc) to configure or customize message conversion.

You can combine `@ResponseBody` methods with JSON serialization views.
See [Jackson JSON](web/webmvc/mvc-controller/ann-methods/jackson.adoc) for details.
