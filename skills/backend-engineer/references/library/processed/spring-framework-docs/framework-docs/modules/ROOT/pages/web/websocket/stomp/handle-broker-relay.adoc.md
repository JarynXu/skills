...
> Upstream path: `framework-docs/modules/ROOT/pages/web/websocket/stomp/handle-broker-relay.adoc`  
> Upstream Git blob: `8150421b59afaee5f09b008740bb0c6cd0c593d8`  
...
in [Sending Messages](web/websocket/stomp/handle-send.adoc), to broadcast messages to subscribed WebSocket clients.
