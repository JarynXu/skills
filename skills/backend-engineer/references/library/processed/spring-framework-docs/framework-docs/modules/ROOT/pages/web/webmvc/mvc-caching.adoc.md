...
> Upstream path: `framework-docs/modules/ROOT/pages/web/webmvc/mvc-caching.adoc`  
> Upstream Git blob: `0ef13fa55fa120dc9fb0c5bde1d1dc24fc3867f3`  
...
[.small]#[See equivalent in the Reactive stack](web/webflux/caching.adoc)#
...
## `CacheControl`
[.small]#[See equivalent in the Reactive stack](web/webflux/caching.adoc#webflux-caching-cachecontrol)#
...
## Controllers
[.small]#[See equivalent in the Reactive stack](web/webflux/caching.adoc#webflux-caching-etag-lastmodified)#
...
## Static Resources
[.small]#[See equivalent in the Reactive stack](web/webflux/caching.adoc#webflux-caching-static-resources)#

You should serve static resources with a `Cache-Control` and conditional response headers
for optimal performance. See the section on configuring [Static Resources](web/webmvc/mvc-config/static-resources.adoc).
...
response content and, thus, save bandwidth but not CPU time. See [Shallow ETag](web/webmvc/filters.adoc#filters-shallow-etag).
