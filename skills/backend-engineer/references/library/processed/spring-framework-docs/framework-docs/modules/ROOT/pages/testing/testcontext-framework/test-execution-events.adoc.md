...
> Upstream path: `framework-docs/modules/ROOT/pages/testing/testcontext-framework/test-execution-events.adoc`  
> Upstream Git blob: `90f2fee4a74ce589a159dc4842253171e796e3e4`  
...
[Annotation-based Event Listeners](core/beans/context-introduction.adoc#context-functionality-events-annotation)).
