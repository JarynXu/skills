...
> Upstream path: `framework-docs/modules/ROOT/pages/core/beans/dependencies/factory-collaborators.adoc`  
> Upstream Git blob: `2d660fc011622b4dbb79ecaa8c51e3dbe16ac082`  
...
for optional dependencies. Note that use of the [@Autowired](core/beans/annotation-config/autowired.adoc)
...
later. Management through [JMX MBeans](integration/jmx.adoc) is therefore a compelling
...
when the container is created. Scopes are defined in [Bean Scopes](core/beans/factory-scopes.adoc). Otherwise,
...
methods (such as a [configured init method](core/beans/factory-nature.adoc#beans-factory-lifecycle-initializingbean)
or the [InitializingBean callback method](core/beans/factory-nature.adoc#beans-factory-lifecycle-initializingbean))
are invoked.
