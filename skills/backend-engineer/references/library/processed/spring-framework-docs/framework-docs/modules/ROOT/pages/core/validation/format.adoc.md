...
> Upstream path: `framework-docs/modules/ROOT/pages/core/validation/format.adoc`  
> Upstream Git blob: `1ab37bdc15abe3ade9225c5b3df801ef82da0ef9`  
...
As discussed in the previous section, [`core.convert`](core/validation/convert.adoc) is a
...
See [Conversion and Formatting](web/webmvc/mvc-config/conversion.adoc) in the Spring MVC chapter.
