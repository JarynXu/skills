...
> Upstream path: `framework-docs/modules/ROOT/pages/web/webmvc/mvc-servlet/viewresolver.adoc`  
> Upstream Git blob: `3a121dabf7dce66713eab3b8ab4ac60b891abb5d`  
...
[.small]#[See equivalent in the Reactive stack](web/webflux/dispatcher-handler.adoc#webflux-viewresolution)#
...
## Handling
[.small]#[See equivalent in the Reactive stack](web/webflux/dispatcher-handler.adoc#webflux-viewresolution-handling)#
...
configuration. The [MVC Config](web/webmvc/mvc-config.adoc) provides a dedicated configuration API for
[View Resolvers](web/webmvc/mvc-config/view-resolvers.adoc) and for adding logic-less
[View Controllers](web/webmvc/mvc-config/view-controller.adoc) which are useful for HTML template
rendering without controller logic.


[[mvc-redirecting-redirect-prefix]]
## Redirecting
[.small]#[See equivalent in the Reactive stack](web/webflux/dispatcher-handler.adoc#webflux-redirecting-redirect-prefix)#
...
## Content Negotiation
[.small]#[See equivalent in the Reactive stack](web/webflux/dispatcher-handler.adoc#webflux-multiple-representations)#
...
See [View Resolvers](web/webmvc/mvc-config/view-resolvers.adoc) under [MVC Config](web/webmvc/mvc-config.adoc) for configuration details.
