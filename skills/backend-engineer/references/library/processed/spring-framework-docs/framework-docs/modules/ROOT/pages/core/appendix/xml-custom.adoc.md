...
> Upstream path: `framework-docs/modules/ROOT/pages/core/appendix/xml-custom.adoc`  
> Upstream Git blob: `d3cb7d68be009ddf6739ad66c34f1b2d3e79159d`  
...
Spring distribution, you should first read the previous section on [XML Schemas](core/appendix/xsd-schemas.adoc).
...
* `BeanDefinitionHolder decorate(Node, BeanDefinitionHolder, ParserContext)`: Called
  ...
  [scopes that Spring supports](core/beans/factory-scopes.adoc).
