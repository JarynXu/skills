...
> Upstream path: `framework-docs/modules/ROOT/pages/testing/testcontext-framework/parallel-test-execution.adoc`  
> Upstream Git blob: `9cfa44c145f48869a8527beb1849642649ae55f3`  
...
of the cache. See the discussion on [context caching](testing/testcontext-framework/ctx-management/caching.adoc)
for details.
====
