...
> Upstream path: `framework-docs/modules/ROOT/pages/data-access/jdbc/embedded-database-support.adoc`  
> Upstream Git blob: `f848360c9a7151b190e4a140a0e4c1c67d4b5bd4`  
...
consider using the [Spring TestContext Framework](testing/testcontext-framework.adoc) and
