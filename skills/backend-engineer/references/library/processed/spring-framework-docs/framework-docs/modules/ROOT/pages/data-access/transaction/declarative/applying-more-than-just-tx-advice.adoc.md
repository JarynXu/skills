...
> Upstream path: `framework-docs/modules/ROOT/pages/data-access/transaction/declarative/applying-more-than-just-tx-advice.adoc`  
> Upstream Git blob: `59826ab473c6685081508a7422d9a68282b92a29`  
...
applies to transactions). See [AOP](core/aop.adoc) for detailed coverage of the AOP
...
[Advice ordering](core/aop/ataspectj/advice.adoc#aop-ataspectj-advice-ordering).
