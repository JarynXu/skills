...
> Upstream path: `framework-docs/modules/ROOT/pages/web/webflux/ann-rest-exceptions.adoc`  
> Upstream Git blob: `023df320b153b6911475acf21a274a6a586e128f`  
...
[.small]#[See equivalent in the Servlet stack](web/webmvc/mvc-ann-rest-exceptions.adoc)#
...
[@ControllerAdvice](web/webflux/controller/ann-advice.adoc) that handles all Spring WebFlux exceptions,
and any `ErrorResponseException`, and renders an error response with a body.


[[webflux-ann-rest-exceptions-render]]
## Render
[.small]#[See equivalent in the Servlet stack](web/webmvc/mvc-ann-rest-exceptions.adoc#mvc-ann-rest-exceptions-render)#
...
[@ControllerAdvice](web/webflux/controller/ann-advice.adoc) in Spring configuration. The handler
...
[WebFlux Config](web/webflux/config.adoc) with a `WebFluxConfigurer`. Use that to intercept
any RFC 9457 response and take some action.


[[webflux-ann-rest-exceptions-non-standard]]
## Non-Standard Fields
[.small]#[See equivalent in the Servlet stack](web/webmvc/mvc-ann-rest-exceptions.adoc#mvc-ann-rest-exceptions-non-standard)#
...
[.small]#[See equivalent in the Servlet stack](web/webmvc/mvc-ann-rest-exceptions.adoc#mvc-ann-rest-exceptions-i18n)#
...
## Client Handling
[.small]#[See equivalent in the Servlet stack](web/webmvc/mvc-ann-rest-exceptions.adoc#mvc-ann-rest-exceptions-client)#
