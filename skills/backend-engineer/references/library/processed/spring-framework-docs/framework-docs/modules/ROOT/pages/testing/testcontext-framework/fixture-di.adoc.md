...
> Upstream path: `framework-docs/modules/ROOT/pages/testing/testcontext-framework/fixture-di.adoc`  
> Upstream Git blob: `e269ea300e71b6fa9f64e63c66a7663dd3bb2c6c`  
...
(see [Dependency Injection with `SpringExtension`](testing/testcontext-framework/support-classes.adoc#testcontext-junit-jupiter-di)).
...
Because `@Autowired` is used to perform [autowiring by type](core/beans/dependencies/factory-autowire.adoc)
...
[Goals](testing/integration.adoc#integration-testing-goals) section. The next two code
