...
> Upstream path: `framework-docs/modules/ROOT/pages/core/aop/schema.adoc`  
> Upstream Git blob: `fd5c690a2d3a235ea2b2fd3b2b20efd03cfdbb88`  
...
([@AspectJ support](core/aop/ataspectj.adoc)) for an understanding of writing pointcut expressions and the binding
of advice parameters.

To use the aop namespace tags described in this section, you need to import the
`spring-aop` schema, as described in [XML Schema-based configuration](core/appendix/xsd-schemas.adoc)
. See [the AOP schema](core/appendix/xsd-schemas.adoc#xsd-schemas-aop)
...
[auto-proxying](core/aop-api/autoproxy.adoc) mechanism. This can cause issues (such as advice
...
language as described in [@AspectJ support](core/aop/ataspectj.adoc). If you use the schema based declaration
...
```
<1> References the `businessService` named pointcut defined in [Sharing Named Pointcut Definitions](core/aop/ataspectj/pointcuts.adoc#aop-common-pointcuts).
...
significantly improve the readability of your code. See [Sharing Named Pointcut Definitions](core/aop/ataspectj/pointcuts.adoc#aop-common-pointcuts) for
details.
...
method when it is invoked. See [Around Advice](core/aop/ataspectj/advice.adoc#aop-ataspectj-around-advice) for notes on calling
...
[Advice Parameters](core/aop/ataspectj/advice.adoc#aop-ataspectj-advice-params) for details.
...
[Determining Argument Names](core/aop/ataspectj/advice.adoc#aop-ataspectj-advice-params-names)).
...
[Combining Pointcut Expressions](core/aop/ataspectj/pointcuts.adoc#aop-pointcuts-combining).
...
Java::
+
```java,indent=0,subs="verbatim",chomp="-packages"
...
Kotlin::
+
```kotlin,indent=0,subs="verbatim",chomp="-packages"
	package com.xyz.service
...
[Advice Ordering](core/aop/ataspectj/advice.adoc#aop-ataspectj-advice-ordering). The
...
[Advice Types in Spring](core/aop-api/advice.adoc#aop-api-advice-types).
...
[An AOP Example](core/aop/ataspectj/example.adoc) looks when rewritten with the schema support.
