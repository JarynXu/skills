...
> Upstream path: `framework-docs/modules/ROOT/pages/testing/testcontext-framework/tel-config.adoc`  
> Upstream Git blob: `ba40e8785d58edc931a66e929a82891396f37fd2`  
...
* `ApplicationEventsTestExecutionListener`: Provides support for
  [`ApplicationEvents`](testing/testcontext-framework/application-events.adoc).
* `BeanOverrideTestExecutionListener`: Provides support for
  [testing/testcontext-framework/bean-overriding.adoc](testing/testcontext-framework/bean-overriding.adoc).
...
* `EventPublishingTestExecutionListener`: Publishes test execution events to the test's
  `ApplicationContext` (see [Test Execution Events](testing/testcontext-framework/test-execution-events.adoc)).
...
[annotation support](testing/annotations.adoc) and the javadoc for
