...
> Upstream path: `framework-docs/modules/ROOT/pages/web/webmvc/mvc-config/static-resources.adoc`  
> Upstream Git blob: `f99633545081b8af7df27ea68a296e07c90706a6`  
...
[.small]#[See equivalent in the Reactive stack](web/webflux/config.adoc#webflux-config-static-resources)#
...
See also
[HTTP caching support for static resources](web/webmvc/mvc-caching.adoc#mvc-caching-static-resources).
