...
> Upstream path: `framework-docs/modules/ROOT/pages/web/webmvc/mvc-controller/ann-validation.adoc`  
> Upstream Git blob: `45e5c632f4b78e75273f5b2dece422390bc81efc`  
...
[.small]#[See equivalent in the Reactive stack](web/webflux/controller/ann-validation.adoc)#

Spring MVC has built-in [validation](core/validation/validator.adoc) for
...
[@ModelAttribute](web/webmvc/mvc-controller/ann-methods/modelattrib-method-args.adoc),
[@RequestBody](web/webmvc/mvc-controller/ann-methods/requestbody.adoc), and
[@RequestPart](web/webmvc/mvc-controller/ann-methods/multipart-forms.adoc) method parameter
...
[WebMvc config](web/webmvc/mvc-config/validation.adoc), or locally through an
[@InitBinder](web/webmvc/mvc-controller/ann-initbinder.adoc) method in an
...
The [Error Responses](web/webmvc/mvc-ann-rest-exceptions.adoc) section provides further
