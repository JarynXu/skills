...
> Upstream path: `framework-docs/modules/ROOT/pages/core/aop/introduction-spring-defn.adoc`  
> Upstream Git blob: `a59efbed2d326529b617b0dee8a45d45afe7171a`  
...
API. Spring AOP remains backward-compatible. See [the following chapter](core/aop-api.adoc)
...
See [Choosing which AOP Declaration Style to Use](core/aop/choosing.adoc) for a more
