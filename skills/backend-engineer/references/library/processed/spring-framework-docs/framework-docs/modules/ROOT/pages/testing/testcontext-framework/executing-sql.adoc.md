...
> Upstream path: `framework-docs/modules/ROOT/pages/testing/testcontext-framework/executing-sql.adoc`  
> Upstream Git blob: `c97e2df8646ba6083d3964738ad9815506507e52`  
...
[Embedded database support](data-access/jdbc/embedded-database-support.adoc) and
[Testing data access logic with an embedded database](data-access/jdbc/embedded-database-support.adoc#jdbc-embedded-database-dao-testing)
 for details.
...
`TransactionalTestExecutionListener` (see [transaction management](testing/testcontext-framework/tx.adoc) for
details).
...
[`@SqlMergeMode` annotation documentation section](testing/annotations/integration-spring/annotation-sqlmergemode.adoc)
