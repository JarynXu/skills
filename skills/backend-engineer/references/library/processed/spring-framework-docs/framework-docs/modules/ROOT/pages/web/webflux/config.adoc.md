...
> Upstream path: `framework-docs/modules/ROOT/pages/web/webflux/config.adoc`  
> Upstream Git blob: `d8490956e63f0edc87127ba02180f194f6be3a89`  
...
[.small]#[See equivalent in the Servlet stack](web/webmvc/mvc-config.adoc)#
...
in [Special Bean Types](web/webflux/dispatcher-handler.adoc#webflux-special-bean-types).
...
[.small]#[See equivalent in the Servlet stack](web/webmvc/mvc-config/enable.adoc)#
...
[infrastructure beans](web/webflux/dispatcher-handler.adoc#webflux-special-bean-types) and adapts to dependencies
available on the classpath -- for JSON, XML, and others.


[[webflux-config-customize]]
## WebFlux config API
[.small]#[See equivalent in the Servlet stack](web/webmvc/mvc-config/customize.adoc)#
...
[.small]#[See equivalent in the Servlet stack](web/webmvc/mvc-config/conversion.adoc)#
...
NOTE: See [`FormatterRegistrar` SPI](core/validation/format.adoc#format-FormatterRegistrar-SPI)
...
## Validation
[.small]#[See equivalent in the Servlet stack](web/webmvc/mvc-config/validation.adoc)#
...
is registered as a global [validator](core/validation/validator.adoc) for use with `@Valid` and
...
[.small]#[See equivalent in the Servlet stack](web/webmvc/mvc-config/content-negotiation.adoc)#
...
## HTTP message codecs
[.small]#[See equivalent in the Servlet stack](web/webmvc/mvc-config/message-converters.adoc)#
...
## View Resolvers
[.small]#[See equivalent in the Servlet stack](web/webmvc/mvc-config/view-resolvers.adoc)#
...
To support [Content Negotiation](web/webflux/dispatcher-handler.adoc#webflux-multiple-representations) and rendering other formats
...
[Codecs](web/webflux/reactive-spring.adoc#webflux-codecs) from `spring-web`. The following example shows how to do so:
...
See [View Technologies](web/webflux-view.adoc) for more on the view technologies that are integrated with Spring WebFlux.


[[webflux-config-static-resources]]
## Static Resources
[.small]#[See equivalent in the Servlet stack](web/webmvc/mvc-config/static-resources.adoc)#
...
See also [HTTP caching support for static resources](web/webflux/caching.adoc#webflux-caching-static-resources).
...
## Path Matching
[.small]#[See equivalent in the Servlet stack](web/webmvc/mvc-config/path-matching.adoc)#
...
are also [recommend](web/webmvc/mvc-controller/ann-requestmapping.adoc#mvc-ann-requestmapping-rfd) moving away from
reliance on it.
====
...
## API Version
[.small]#[See equivalent in the Servlet stack](web/webmvc/mvc-config/api-version.adoc)#
...
a custom [ApiVersionParser](web/webflux-versioning.adoc#webflux-versioning-parser).
...
[controller methods](web/webflux/controller/ann-requestmapping.adoc#webflux-ann-requestmapping-version)
...
[.small]#[See equivalent in the Servlet stack](web/webmvc/mvc-config/advanced-java.adoc)#
