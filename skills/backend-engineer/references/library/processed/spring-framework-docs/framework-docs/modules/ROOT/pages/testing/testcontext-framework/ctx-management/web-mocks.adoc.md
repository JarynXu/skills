...
> Upstream path: `framework-docs/modules/ROOT/pages/testing/testcontext-framework/ctx-management/web-mocks.adoc`  
> Upstream Git blob: `578a3f88733d1186c3f60f279388b2e4fa13983d`  
...
`WebApplicationContext`, this [`TestExecutionListener`](testing/testcontext-framework/key-abstractions.adoc)
