...
> Upstream path: `framework-docs/modules/ROOT/pages/core/beans/factory-scopes.adoc`  
> Upstream Git blob: `3622f9a1ae3bdd95efe05b12b23c27b1dee7a46a`  
...
| [websocket](web/websocket/stomp/scope.adoc)
...
custom [bean post-processor](core/beans/factory-extension.adoc#beans-factory-extension-bpp)
...
container, see [Lifecycle Callbacks](core/beans/factory-nature.adoc#beans-factory-lifecycle).)
...
runtime more than once, see [Method Injection](core/beans/dependencies/factory-method-injection.adoc).
...
[WebSocket scope](web/websocket/stomp/scope.adoc) for more details.
...
See [here](core/beans/standard-annotations.adoc) for more details on JSR-330 overall.
====
...
and [XML Schema-based configuration](core/appendix/xsd-schemas.adoc)).
...
see [Proxying Mechanisms](core/aop/proxying.adoc).
