...
> Upstream path: `framework-docs/modules/ROOT/pages/core/beans/dependencies/factory-autowire.adoc`  
> Upstream Git blob: `1f92c7d521bb34ccfa987d4070cef257c49f8c56`  
...
* Autowiring can significantly reduce the need to specify properties or constructor
  ...
  [discussed elsewhere in this chapter](core/beans/child-bean-definitions.adoc) are also valuable
  in this regard.)
...
[Dependency Injection](core/beans/dependencies/factory-collaborators.adoc)), you
...
* Implement the more fine-grained control available with annotation-based configuration,
  as described in [Annotation-based Container Configuration](core/beans/annotation-config.adoc).
...
injection points such as [`@Autowired`](core/beans/annotation-config/autowired.adoc).
...
When using [qualifiers](core/beans/annotation-config/autowired-qualifiers.adoc),
