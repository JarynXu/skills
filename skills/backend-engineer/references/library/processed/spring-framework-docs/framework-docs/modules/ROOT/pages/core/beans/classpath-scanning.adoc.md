...
> Upstream path: `framework-docs/modules/ROOT/pages/core/beans/classpath-scanning.adoc`  
> Upstream Git blob: `25e1e1de9b42356e14dbdb5efa4a31f9d1426631`  
...
([Annotation-based Container Configuration](core/beans/annotation-config.adoc))
...
[Exception Translation](data-access/orm/general.adoc#orm-exception-translation).
...
see [Request, Session, Application, and WebSocket Scopes](core/beans/factory-scopes.adoc#beans-factory-scopes-other).
...
[Fine-tuning Annotation-based Autowiring with Qualifiers](core/beans/annotation-config/autowired-qualifiers.adoc).
