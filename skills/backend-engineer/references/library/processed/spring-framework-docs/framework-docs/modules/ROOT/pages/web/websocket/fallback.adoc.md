...
> Upstream path: `framework-docs/modules/ROOT/pages/web/websocket/fallback.adoc`  
> Upstream Git blob: `5c39cc7ff4891702c1cbbb552d08a686d6878779`  
...
configuration of a [`DispatcherServlet`](web/webmvc/mvc-servlet.adoc). However, Spring's WebSocket
...
[Allowed Origins](web/websocket/server.adoc#websocket-server-allowed-origins)), the SockJS
