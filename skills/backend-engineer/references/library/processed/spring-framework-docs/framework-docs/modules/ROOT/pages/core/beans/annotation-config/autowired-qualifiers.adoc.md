...
> Upstream path: `framework-docs/modules/ROOT/pages/core/beans/annotation-config/autowired-qualifiers.adoc`  
> Upstream Git blob: `08dd2c5fbe98fa32da489962cf1efa041316e6d8`  
...
[Self Injection](core/beans/annotation-config/autowired.adoc#beans-autowired-annotation-self-injection)
for details.
...
In [Classpath Scanning and Managed Components](core/beans/classpath-scanning.adoc), you can see an annotation-based alternative to
providing the qualifier metadata in XML. Specifically, see [Providing Qualifier Metadata with Annotations](core/beans/classpath-scanning.adoc#beans-scanning-qualifiers).
