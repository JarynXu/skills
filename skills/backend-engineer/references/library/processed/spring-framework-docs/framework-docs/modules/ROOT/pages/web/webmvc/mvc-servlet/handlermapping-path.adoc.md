...
> Upstream path: `framework-docs/modules/ROOT/pages/web/webmvc/mvc-servlet/handlermapping-path.adoc`  
> Upstream Git blob: `3627ca857e2533900438a575e1e4819d8f7132c5`  
...
a `UrlPathHelper` with `alwaysUseFullPath=true` via [Path Matching](web/webmvc/mvc-config/path-matching.adoc) in
the MVC config.
...
[Pattern Comparison](web/webmvc/mvc-controller/ann-requestmapping.adoc#mvc-ann-requestmapping-pattern-comparison).
