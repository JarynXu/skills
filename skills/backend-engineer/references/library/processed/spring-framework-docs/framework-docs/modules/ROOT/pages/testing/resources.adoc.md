...
> Upstream path: `framework-docs/modules/ROOT/pages/testing/resources.adoc`  
> Upstream Git blob: `0378ad6efc508f2e38c6c6017ef2197287c7eabd`  
...
{assertj-docs}[AssertJ] ::
  ...
  [MockMvc testing support](testing/mockmvc/assertj.adoc).
