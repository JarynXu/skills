...
> Upstream path: `framework-docs/modules/ROOT/pages/web/webflux/controller/ann-requestmapping.adoc`  
> Upstream Git blob: `a954d272bea3a518885a07fd3420f7c8fc60cca4`  
...
[.small]#[See equivalent in the Servlet stack](web/webmvc/mvc-controller/ann-requestmapping.adoc)#
...
[.small]#[See equivalent in the Servlet stack](web/webmvc/mvc-controller/ann-requestmapping.adoc#mvc-ann-requestmapping-annotation)#
...
## URI Patterns
[.small]#[See equivalent in the Servlet stack](web/webmvc/mvc-controller/ann-requestmapping.adoc#mvc-ann-requestmapping-uri-templates)#
...
See [Type Conversion](web/webflux/controller/ann-methods/typeconversion.adoc) and [`DataBinder`](web/webflux/controller/ann-initbinder.adoc).
...
## Pattern Comparison
[.small]#[See equivalent in the Servlet stack](web/webmvc/mvc-controller/ann-requestmapping.adoc#mvc-ann-requestmapping-pattern-comparison)#
...
[.small]#[See equivalent in the Servlet stack](web/webmvc/mvc-controller/ann-requestmapping.adoc#mvc-ann-requestmapping-consumes)#
...
[.small]#[See equivalent in the Servlet stack](web/webmvc/mvc-controller/ann-requestmapping.adoc#mvc-ann-requestmapping-produces)#
...
[.small]#[See equivalent in the Servlet stack](web/webmvc/mvc-controller/ann-requestmapping.adoc#mvc-ann-requestmapping-params-and-headers)#
...
## API Version
[.small]#[See equivalent in the Servlet stack](web/webmvc/mvc-controller/ann-requestmapping.adoc#mvc-ann-requestmapping-version)#

There is no standard way to specify an API version, so when you enable API versioning
in the [WebFlux Config](web/webflux/config.adoc#webflux-config-api-version) you need
to specify how to resolve the version. The WebFlux Config creates an
[ApiVersionStrategy](web/webflux-versioning.adoc#webflux-versioning-strategy) that in turn
...
[supported versions](web/webflux/config.adoc#webflux-config-api-version) above
...
[configured as supported](web/webflux/config.adoc#webflux-config-api-version).
...
See [API Versioning](web/webflux-versioning.adoc) for more details on underlying
infrastructure and support for API Versioning.


[[webflux-ann-requestmapping-head-options]]
## HTTP HEAD, OPTIONS
[.small]#[See equivalent in the Servlet stack](web/webmvc/mvc-controller/ann-requestmapping.adoc#mvc-ann-requestmapping-head-options)#
...
## Custom Annotations
[.small]#[See equivalent in the Servlet stack](web/webmvc/mvc-controller/ann-requestmapping.adoc#mvc-ann-requestmapping-composed)#

Spring WebFlux supports the use of [composed annotations](core/beans/classpath-scanning.adoc#beans-meta-annotations)
...
[.small]#[See equivalent in the Servlet stack](web/webmvc/mvc-controller/ann-requestmapping.adoc#mvc-ann-requestmapping-registration)#
...
## `@HttpExchange`
[.small]#[See equivalent in the Servlet stack](web/webmvc/mvc-controller/ann-requestmapping.adoc#mvc-ann-httpexchange-annotation)#

While the main purpose of `@HttpExchange` is for an HTTP Service
[client with a generated proxy](integration/rest-clients.adoc#rest-http-service-client),
...
[@RequestMapping](web/webflux/controller/ann-methods/arguments.adoc).
