...
> Upstream path: `framework-docs/modules/ROOT/pages/core/expressions/language-ref/properties-arrays.adoc`  
> Upstream Git blob: `a55e91a8acb33335a9f3d79b9dbfcd3ed501345b`  
...
TIP: See the [Safe Navigation Operator](core/expressions/language-ref/operator-safe-navigation.adoc)
...
[Classes used in the examples](core/expressions/example-classes.adoc) section. To
...
[compilation](core/expressions/evaluation.adoc#expressions-spel-compilation) of
...
support [compilation](core/expressions/evaluation.adoc#expressions-spel-compilation)
