...
> Upstream path: `framework-docs/modules/ROOT/pages/web/webmvc-view/mvc-xslt.adoc`  
> Upstream Git blob: `8e8358335e8445774eac9941b9f07df5ff3321bf`  
...
name of our XSLT view. See [Annotated Controllers](web/webmvc/mvc-controller.adoc)
...
```html,indent=0,subs="verbatim,quotes"
<html>
	<head>
