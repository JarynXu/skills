...
> Upstream path: `framework-docs/modules/ROOT/pages/core/beans/environment.adoc`  
> Upstream Git blob: `b8120bfafb49753f9470201d3b0651ec7987c66d`  
...
You can use `@Profile` as a [meta-annotation](core/beans/classpath-scanning.adoc#beans-meta-annotations) for the purpose
...
module (see [context configuration with environment profiles](testing/testcontext-framework/ctx-management/env-profiles.adoc)
).
