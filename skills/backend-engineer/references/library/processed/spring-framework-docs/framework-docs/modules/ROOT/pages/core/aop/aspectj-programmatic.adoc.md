...
> Upstream path: `framework-docs/modules/ROOT/pages/core/aop/aspectj-programmatic.adoc`  
> Upstream Git blob: `b7fde6aa6a027e1b0ae051894899bdc69080735f`  
...
[next chapter](core/aop-api.adoc). Here, we want to focus on the ability to automatically
