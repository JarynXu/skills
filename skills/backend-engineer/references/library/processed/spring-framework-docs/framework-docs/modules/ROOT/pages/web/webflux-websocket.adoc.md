...
> Upstream path: `framework-docs/modules/ROOT/pages/web/webflux-websocket.adoc`  
> Upstream Git blob: `e08eed91825914194d4bf99913391ae3fec32854`  
...
[.small]#[See equivalent in the Servlet stack](web/websocket.adoc)#
...
## WebSocket API
[.small]#[See equivalent in the Servlet stack](web/websocket/stomp/server-config.adoc)#
...
### Server
[.small]#[See equivalent in the Servlet stack](web/websocket/server.adoc#websocket-server-handler)#
...
If using the [WebFlux Config](web/webflux/dispatcher-handler.adoc#webflux-framework-config) there is nothing
...
[Data Buffers and Codecs](core/databuffer-codec.adoc).
...
### Handshake
[.small]#[See equivalent in the Servlet stack](web/websocket/server.adoc#websocket-server-handshake)#
...
[.small]#[See equivalent in the Servlet stack](web/websocket/server.adoc#websocket-server-runtime-configuration)#
...
[WebFlux Config](web/webflux/config.adoc#webflux-config-websocket-service), or otherwise if
...
### CORS
[.small]#[See equivalent in the Servlet stack](web/websocket/server.adoc#websocket-server-allowed-origins)#
