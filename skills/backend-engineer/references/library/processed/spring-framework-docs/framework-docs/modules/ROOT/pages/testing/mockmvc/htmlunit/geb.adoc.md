...
> Upstream path: `framework-docs/modules/ROOT/pages/testing/mockmvc/htmlunit/geb.adoc`  
> Upstream Git blob: `c92d0cc2dde3db27c6a1b85af960cd0d63191bbb`  
...
[same benefits](testing/mockmvc/htmlunit/webdriver.adoc#mockmvc-server-htmlunit-webdriver-why)
...
usage, see
[Advanced `MockMvcHtmlUnitDriverBuilder`](testing/mockmvc/htmlunit/webdriver.adoc#mockmvc-server-htmlunit-webdriver-advanced-builder).
...
[HtmlUnit test](testing/mockmvc/htmlunit/mah.adoc#mockmvc-server-htmlunit-mah-usage)
