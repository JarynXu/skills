...
> Upstream path: `framework-docs/modules/ROOT/pages/web/websocket/stomp/configuration-performance.adoc`  
> Upstream Git blob: `c1706a321d3867a5f0aea0ce467fbf2515a27d2a`  
...
recommended to review [Flow of Messages](web/websocket/stomp/message-flow.adoc).
