...
> Upstream path: `framework-docs/modules/ROOT/pages/data-access/transaction/declarative.adoc`  
> Upstream Git blob: `ef690da3ef6e0a71c15408e3ba17384fb141b584`  
...
* The Spring Framework offers declarative
  [rollback rules](data-access/transaction/declarative/rolling-back.adoc), a feature with no EJB
