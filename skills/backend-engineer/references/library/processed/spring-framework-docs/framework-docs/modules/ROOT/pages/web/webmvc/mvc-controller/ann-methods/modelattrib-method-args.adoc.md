...
> Upstream path: `framework-docs/modules/ROOT/pages/web/webmvc/mvc-controller/ann-methods/modelattrib-method-args.adoc`  
> Upstream Git blob: `52ee83c4f0e42c0ddbd3d6b174516e5da543800d`  
...
[.small]#[See equivalent in the Reactive stack](web/webflux/controller/ann-methods/modelattrib-method-args.adoc)#
...
* Accessed from the model where it could have been added by a
  [@ModelAttribute method](web/webmvc/mvc-controller/ann-modelattrib-methods.adoc).
* Accessed from the HTTP session if the model attribute was listed in
  the class-level [`@SessionAttributes`](web/webmvc/mvc-controller/ann-methods/sessionattributes.adoc) annotation.
...
[model design](web/webmvc/mvc-controller/ann-initbinder.adoc#mvc-ann-initbinder-model-design).
...
See [Bean Validation](core/validation/beanvalidation.adoc) and
...
[Validation](web/webmvc/mvc-controller/ann-validation.adoc).
