...
> Upstream path: `documentation/spring-boot-docs/src/docs/antora/modules/reference/pages/messaging/kafka.adoc`  
> Upstream Git blob: `9e02b5b664d6dd0ea7adb0314e107f3d86521528`  
...
See also [messaging/kafka.adoc#messaging.kafka.additional-properties](messaging/kafka.adoc#messaging.kafka.additional-properties) for more information.
