...
> Upstream path: `documentation/spring-boot-docs/src/docs/antora/modules/reference/pages/testing/spring-boot-applications.adoc`  
> Upstream Git blob: `e4e4e19ddf4504e34919519cc10e1c96b240ebee`  
...
The annotation works by [creating the javadoc:org.springframework.context.ApplicationContext[](testing/spring-boot-applications.adoc#testing.spring-boot-applications.detecting-configuration) used in your tests through javadoc:org.springframework.boot.SpringApplication[]].
In addition to javadoc:org.springframework.boot.test.context.SpringBootTest[format=annotation] a number of other annotations are also provided for [testing more specific slices](testing/spring-boot-applications.adoc#testing.spring-boot-applications.autoconfigured-tests) of an application.
...
It can be used in conjunction with [`@AutoConfigureMockMvc`, javadoc:org.springframework.boot.resttestclient.autoconfigure.AutoConfigureRestTestClient[format=annotation](testing/spring-boot-applications.adoc#testing.spring-boot-applications.with-mock-environment)], or javadoc:org.springframework.boot.webtestclient.autoconfigure.AutoConfigureWebTestClient[format=annotation]] for mock-based testing of your web application.
...
As long as you [structured your code](using/structuring-your-code.adoc) in a sensible way, your main configuration is usually found.

[NOTE]
====
If you use a [test annotation to test a more specific slice of your application](testing/spring-boot-applications.adoc#testing.spring-boot-applications.autoconfigured-tests), you should avoid adding configuration settings that are specific to a particular area on the [main method's application class](testing/spring-boot-applications.adoc#testing.spring-boot-applications.user-configuration-and-slicing).
...
As we [have seen earlier](testing/spring-boot-applications.adoc#testing.spring-boot-applications.detecting-configuration), javadoc:org.springframework.boot.test.context.TestConfiguration[format=annotation] can be used on an inner class of a test to customize the primary configuration.
...
If your application expects [arguments](features/spring-application.adoc#features.spring-application.application-arguments), you can
...
TIP: If you want to focus only on the web layer and not start a complete javadoc:org.springframework.context.ApplicationContext[], consider [using javadoc:org.springframework.boot.webmvc.test.autoconfigure.WebMvcTest[format=annotation](testing/spring-boot-applications.adoc#testing.spring-boot-applications.spring-mvc-tests) instead].
...
This means that, whilst you can test your MVC layer throws and handles exceptions as expected, you cannot directly test that a specific [custom error page](web/servlet.adoc#web.servlet.spring-mvc.error-handling.error-pages) is rendered.
...
The javadoc:org.springframework.boot.test.web.server.LocalServerPort[format=annotation] annotation can be used to [inject the actual port used](how-to:webserver.adoc#howto.webserver.discover-port) into your test.
...
TIP: javadoc:org.springframework.test.web.reactive.server.WebTestClient[] can also be used with a [mock environment](testing/spring-boot-applications.adoc#testing.spring-boot-applications.with-mock-environment), removing the need for a running server, by annotating your test class with javadoc:org.springframework.boot.webtestclient.autoconfigure.AutoConfigureWebTestClient[format=annotation] from `spring-boot-webflux-test`.

NOTE: For certain [sliced tests](testing/spring-boot-applications.adoc#testing.spring-boot-applications.autoconfigured-tests) you may need to use the javadoc:org.springframework.boot.web.server.test.AutoConfigureWebServer[format=annotation] annotation to auto-configure an embedded web server.
...
Meter registries are not added to the [global registry](actuator/metrics.adoc#actuator.metrics.getting-started) by default in tests.
...
If you annotate [a sliced test](testing/spring-boot-applications.adoc#testing.spring-boot-applications.autoconfigured-tests) with javadoc:org.springframework.boot.micrometer.tracing.test.autoconfigure.AutoConfigureTracing[format=annotation] , it auto-configures a no-op javadoc:io.micrometer.tracing.Tracer[].
...
When combined with `spring-boot-test-autoconfigure`, Spring Boot's [test modules](reference:testing/test-modules.adoc) include a number of annotations that can be used to automatically configure such "`slices`".
...
TIP: A list of the auto-configurations that are enabled by javadoc:org.springframework.boot.test.autoconfigure.json.JsonTest[format=annotation] can be [found in the appendix](appendix:test-auto-configuration/index.adoc).
...
TIP: A list of the auto-configuration settings that are enabled by javadoc:org.springframework.boot.webmvc.test.autoconfigure.WebMvcTest[format=annotation] can be [found in the appendix](appendix:test-auto-configuration/index.adoc).
...
More details on how to use Spring Security's javadoc:org.springframework.test.web.servlet.MockMvc[] support can be found in this [how-to:testing.adoc#howto.testing.with-spring-security](how-to:testing.adoc#howto.testing.with-spring-security) "`How-to Guides`" section.

TIP: Sometimes writing Spring MVC tests is not enough; Spring Boot can help you run [full end-to-end tests with an actual server](testing/spring-boot-applications.adoc#testing.spring-boot-applications.with-running-server).
...
TIP: A list of the auto-configurations that are enabled by javadoc:org.springframework.boot.webflux.test.autoconfigure.WebFluxTest[format=annotation] can be [found in the appendix](appendix:test-auto-configuration/index.adoc).
...
TIP: Sometimes writing Spring WebFlux tests is not enough; Spring Boot can help you run [full end-to-end tests with an actual server](testing/spring-boot-applications.adoc#testing.spring-boot-applications.with-running-server).
...
TIP: A list of the auto-configurations that are enabled by javadoc:org.springframework.boot.graphql.test.autoconfigure.GraphQlTest[format=annotation] can be [found in the appendix](appendix:test-auto-configuration/index.adoc).
...
javadoc:org.springframework.boot.context.properties.EnableConfigurationProperties[format=annotation] can be used to include javadoc:org.springframework.boot.context.properties.ConfigurationProperties[format=annotation] beans.
(For more about using Cassandra with Spring Boot, see [data/nosql.adoc#data.nosql.cassandra](data/nosql.adoc#data.nosql.cassandra).)

TIP: A list of the auto-configuration settings that are enabled by javadoc:org.springframework.boot.data.cassandra.test.autoconfigure.DataCassandraTest[format=annotation] can be [found in the appendix](appendix:test-auto-configuration/index.adoc).
...
javadoc:org.springframework.boot.context.properties.EnableConfigurationProperties[format=annotation] can be used to include javadoc:org.springframework.boot.context.properties.ConfigurationProperties[format=annotation] beans.
(For more about using Couchbase with Spring Boot, see [data/nosql.adoc#data.nosql.couchbase](data/nosql.adoc#data.nosql.couchbase), earlier in this chapter.)

TIP: A list of the auto-configuration settings that are enabled by javadoc:org.springframework.boot.data.couchbase.test.autoconfigure.DataCouchbaseTest[format=annotation] can be [found in the appendix](appendix:test-auto-configuration/index.adoc).
...
javadoc:org.springframework.boot.context.properties.EnableConfigurationProperties[format=annotation] can be used to include javadoc:org.springframework.boot.context.properties.ConfigurationProperties[format=annotation] beans.
(For more about using Elasticsearch with Spring Boot, see [data/nosql.adoc#data.nosql.elasticsearch](data/nosql.adoc#data.nosql.elasticsearch), earlier in this chapter.)

TIP: A list of the auto-configuration settings that are enabled by javadoc:org.springframework.boot.data.elasticsearch.test.autoconfigure.DataElasticsearchTest[format=annotation] can be [found in the appendix](appendix:test-auto-configuration/index.adoc).
...
TIP: A list of the auto-configuration settings that are enabled by javadoc:org.springframework.boot.data.jpa.test.autoconfigure.DataJpaTest[format=annotation] can be [found in the appendix](appendix:test-auto-configuration/index.adoc).
...
TIP: A list of the auto-configurations that are enabled by javadoc:org.springframework.boot.jdbc.test.autoconfigure.JdbcTest[format=annotation] can be [found in the appendix](appendix:test-auto-configuration/index.adoc).
...
(See [testing/spring-boot-applications.adoc#testing.spring-boot-applications.autoconfigured-spring-data-jpa](testing/spring-boot-applications.adoc#testing.spring-boot-applications.autoconfigured-spring-data-jpa).)
...
TIP: A list of the auto-configurations that are enabled by javadoc:org.springframework.boot.data.jdbc.test.autoconfigure.DataJdbcTest[format=annotation] can be [found in the appendix](appendix:test-auto-configuration/index.adoc).

By default, Data JDBC tests are transactional and roll back at the end of each test.
See the {url-spring-framework-docs}/testing/testcontext-framework/tx.html#testcontext-tx-enabling-transactions[relevant section] in the Spring Framework Reference Documentation for more details.
If that is not what you want, you can disable transaction management for a test or for the whole test class as [shown in the JDBC example](testing/spring-boot-applications.adoc#testing.spring-boot-applications.autoconfigured-jdbc).
...
TIP: A list of the auto-configurations that are enabled by javadoc:org.springframework.boot.data.r2dbc.test.autoconfigure.DataR2dbcTest[format=annotation] can be [found in the appendix](appendix:test-auto-configuration/index.adoc).
...
(For more about using jOOQ with Spring Boot, see [data/sql.adoc#data.sql.jooq](data/sql.adoc#data.sql.jooq).)
...
TIP: A list of the auto-configurations that are enabled by javadoc:org.springframework.boot.jooq.test.autoconfigure.JooqTest[format=annotation] can be [found in the appendix](appendix:test-auto-configuration/index.adoc).
...
javadoc:org.springframework.boot.context.properties.EnableConfigurationProperties[format=annotation] can be used to include javadoc:org.springframework.boot.context.properties.ConfigurationProperties[format=annotation] beans.
(For more about using MongoDB with Spring Boot, see [data/nosql.adoc#data.nosql.mongodb](data/nosql.adoc#data.nosql.mongodb).)

TIP: A list of the auto-configuration settings that are enabled by javadoc:org.springframework.boot.data.mongodb.test.autoconfigure.DataMongoTest[format=annotation] can be [found in the appendix](appendix:test-auto-configuration/index.adoc).
...
javadoc:org.springframework.boot.context.properties.EnableConfigurationProperties[format=annotation] can be used to include javadoc:org.springframework.boot.context.properties.ConfigurationProperties[format=annotation] beans.
(For more about using Neo4J with Spring Boot, see [data/nosql.adoc#data.nosql.neo4j](data/nosql.adoc#data.nosql.neo4j).)

TIP: A list of the auto-configuration settings that are enabled by javadoc:org.springframework.boot.data.neo4j.test.autoconfigure.DataNeo4jTest[format=annotation] can be [found in the appendix](appendix:test-auto-configuration/index.adoc).
...
javadoc:org.springframework.boot.context.properties.EnableConfigurationProperties[format=annotation] can be used to include javadoc:org.springframework.boot.context.properties.ConfigurationProperties[format=annotation] beans.
(For more about using Redis with Spring Boot, see [data/nosql.adoc#data.nosql.redis](data/nosql.adoc#data.nosql.redis).)

TIP: A list of the auto-configuration settings that are enabled by javadoc:org.springframework.boot.data.redis.test.autoconfigure.DataRedisTest[format=annotation] can be [found in the appendix](appendix:test-auto-configuration/index.adoc).
...
javadoc:org.springframework.boot.context.properties.EnableConfigurationProperties[format=annotation] can be used to include javadoc:org.springframework.boot.context.properties.ConfigurationProperties[format=annotation] beans.
(For more about using LDAP with Spring Boot, see [data/nosql.adoc#data.nosql.ldap](data/nosql.adoc#data.nosql.ldap).)

TIP: A list of the auto-configuration settings that are enabled by javadoc:org.springframework.boot.data.ldap.test.autoconfigure.DataLdapTest[format=annotation] can be [found in the appendix](appendix:test-auto-configuration/index.adoc).
...
TIP: A list of the auto-configuration settings that are enabled by javadoc:org.springframework.boot.restclient.test.autoconfigure.RestClientTest[format=annotation] can be [found in the appendix](appendix:test-auto-configuration/index.adoc).
...
TIP: A list of the auto-configuration settings that are enabled by javadoc:org.springframework.boot.webclient.test.autoconfigure.WebClientTest[format=annotation] can be [found in the appendix](appendix:test-auto-configuration/index.adoc).
...
(For more about using Web Services with Spring Boot, see [io/webservices.adoc](io/webservices.adoc).)


TIP: A list of the auto-configuration settings that are enabled by javadoc:org.springframework.boot.webservices.test.autoconfigure.client.WebServiceClientTest[format=annotation] can be [found in the appendix](appendix:test-auto-configuration/index.adoc).
...
TIP: A list of the auto-configuration settings that are enabled by javadoc:org.springframework.boot.webservices.test.autoconfigure.server.WebServiceServerTest[format=annotation] can be [found in the appendix](appendix:test-auto-configuration/index.adoc).
...
If you [structure your code](using/structuring-your-code.adoc) in a sensible way, your javadoc:org.springframework.boot.autoconfigure.SpringBootApplication[format=annotation] class is [used by default](testing/spring-boot-applications.adoc#testing.spring-boot-applications.detecting-configuration) as the configuration of your tests.
...
See [this how-to section](how-to:testing.adoc#howto.testing.slice-tests) for more details on when you might want to enable specific javadoc:org.springframework.context.annotation.Configuration[format=annotation] classes for slice tests.
