...
> Upstream path: `documentation/spring-boot-docs/src/docs/antora/modules/reference/pages/messaging/amqp.adoc`  
> Upstream Git blob: `1718f0abaa7debeb2c0a242969936187e43db51e`  
...
* [Generic AMQP 1.0](messaging/amqp.adoc#messaging.amqp.generic) (`spring-boot-starter-amqp`) — broker-agnostic AMQP 1.0 support based on the Qpid ProtonJ2 client library.
  Use this when portability across AMQP 1.0-compatible brokers such as ActiveMQ, Azure Service Bus, or RabbitMQ is important.
* [RabbitMQ AMQP 1.0](messaging/amqp.adoc#messaging.amqp.rabbitmq) (`spring-boot-starter-amqp-rabbitmq`) — RabbitMQ-specific support via the native https://github.com/rabbitmq/rabbitmq-amqp-java-client[RabbitMQ AMQP 1.0 Java client].
  Use this when your application targets RabbitMQ exclusively and you want to use the AMQP 1.0 protocol.
* [RabbitMQ AMQP 0.9](messaging/amqp.adoc#messaging.amqp.rabbitmq09) (`spring-boot-starter-rabbitmq`) — RabbitMQ support via the classic AMQP 0.9.1 protocol.
...
If the address uses the `amqps` scheme, an [SSL bundle](features/ssl.adoc#features.ssl.bundles) must be configured.
...
To use SSL with RabbitMQ AMQP 1.0, set configprop:spring.amqp.rabbitmq.ssl.bundle[] to configure the [SSL bundle](features/ssl.adoc#features.ssl.bundles) to use.
...
#### SSL
To use SSL with RabbitMQ Streams, set configprop:spring.rabbitmq.stream.ssl.enabled[] to `true` or set configprop:spring.rabbitmq.stream.ssl.bundle[] to configure the [SSL bundle](features/ssl.adoc#features.ssl.bundles) to use.
