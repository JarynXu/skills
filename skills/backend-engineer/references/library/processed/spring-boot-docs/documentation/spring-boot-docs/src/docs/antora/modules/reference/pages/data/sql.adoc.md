...
> Upstream path: `documentation/spring-boot-docs/src/docs/antora/modules/reference/pages/data/sql.adoc`  
> Upstream Git blob: `4b87a7e1ea4065eee63609393a2ed11318cb4e08`  
...
TIP: See the [how-to:data-access.adoc#howto.data-access.configure-custom-datasource](how-to:data-access.adoc#howto.data-access.configure-custom-datasource) section of the "`How-to Guides`" for more advanced examples, typically to take full control over the configuration of the DataSource.
...
TIP: The "`How-to Guides`" section includes a [section on how to initialize a database](how-to:data-initialization.adoc).
...
These are the standard options that work regardless of [the actual implementation](data/sql.adoc#data.sql.datasource.connection-pool).
...
By default the [auto-configuration packages](using/auto-configuration.adoc#using.auto-configuration.packages) are scanned.
...
See the [how-to:data-access.adoc#howto.data-access.separate-entity-definitions-from-spring-configuration](how-to:data-access.adoc#howto.data-access.separate-entity-definitions-from-spring-configuration) section of the "`How-to Guides`".
...
If you use auto-configuration, the [auto-configuration packages](using/auto-configuration.adoc#using.auto-configuration.packages) are searched for repositories.
...
If you're using Spring Data JDBC with [ahead-of-time processing](packaging/aot.adoc) (targeting either the JVM or a native image), some additional configuration is recommended.
...
* You are using [Spring Boot's developer tools](using/devtools.adoc).
...
TIP: The "`How-to Guides`" section includes a [section on how to initialize a database](how-to:data-initialization.adoc#howto.data-initialization.using-basic-sql-scripts).
...
Similarly to [the JDBC support](data/sql.adoc#data.sql.datasource.embedded), Spring Boot can automatically configure an embedded database for reactive usage.
You need not provide any connection URLs.
