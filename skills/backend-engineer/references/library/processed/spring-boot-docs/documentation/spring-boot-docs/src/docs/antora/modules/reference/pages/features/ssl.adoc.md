...
> Upstream path: `documentation/spring-boot-docs/src/docs/antora/modules/reference/pages/features/ssl.adoc`  
> Upstream Git blob: `c3e14b6dcbaafe85cc47001eaa9cb953b34c8285`  
...
[TIP]
====
Rather than the location to a file, its [Base64 encoded content](features/external-config.adoc#features.external-config.typesafe-configuration-properties.conversion.base64) can be provided.
...
NOTE: If you're using environment variables to configure the bundle, the name of the bundle is [always converted to lowercase](features/external-config.adoc#features.external-config.typesafe-configuration-properties.relaxed-binding.maps-from-environment-variables).
...
See the sections on [embedded web servers](how-to:webserver.adoc#howto.webserver.configure-ssl), [data technologies](data/index.adoc), and [REST clients](io/rest-client.adoc) for further information.
