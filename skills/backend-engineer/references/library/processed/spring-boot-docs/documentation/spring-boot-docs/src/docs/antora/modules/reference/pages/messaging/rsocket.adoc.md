...
> Upstream path: `documentation/spring-boot-docs/src/docs/antora/modules/reference/pages/messaging/rsocket.adoc`  
> Upstream Git blob: `41d944b3ef12a06360e364f9f939a3a868828df6`  
...
See the [Jackson support section](features/json.adoc#features.json.jackson) to know more about customization possibilities.
