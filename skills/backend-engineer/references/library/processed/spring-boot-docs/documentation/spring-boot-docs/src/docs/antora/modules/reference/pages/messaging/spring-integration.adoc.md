...
> Upstream path: `documentation/spring-boot-docs/src/docs/antora/modules/reference/pages/messaging/spring-integration.adoc`  
> Upstream Git blob: `395f6c98c626e424dd8df2b51768a0d29125f2f2`  
...
Spring Integration polling logic relies [on the auto-configured javadoc:org.springframework.scheduling.TaskScheduler[](features/task-execution-and-scheduling.adoc)].
