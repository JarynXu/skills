...
> Upstream path: `documentation/spring-boot-docs/src/docs/antora/modules/reference/pages/web/spring-graphql.adoc`  
> Upstream Git blob: `0add65c8a45c6156f705746d2a457fc81d45f37c`  
...
Once the [RSocket server is configured](messaging/rsocket.adoc#messaging.rsocket.server-auto-configuration), we can configure our GraphQL handler on a particular route using configprop:spring.graphql.rsocket.mapping[].
...
A default implementation is very useful during development, this is why it is exposed automatically with [`spring-boot-devtools`](using/devtools.adoc) during development.
