...
> Upstream path: `documentation/spring-boot-docs/src/docs/antora/modules/reference/pages/actuator/tracing.adoc`  
> Upstream Git blob: `72c7cb0d6fac415dfc268c4725bad7d72c3d6326`  
...
For our purposes, the simple "`Hello World!`" web application that's covered in the [tutorial:first-application/index.adoc](tutorial:first-application/index.adoc) section will suffice.
...
Please read [this documentation for more details](reference:actuator/observability.adoc#actuator.observability.context-propagation).


[[actuator.micrometer-tracing.propagating-traces]]
## Propagating Traces

To automatically propagate traces over the network, use the auto-configured [`RestClient.Builder`](io/rest-client.adoc#io.rest-client.restclient) or [`WebClient.Builder`](io/rest-client.adoc#io.rest-client.webclient) to construct the client.
...
See [testing/spring-boot-applications.adoc#testing.spring-boot-applications.tracing](testing/spring-boot-applications.adoc#testing.spring-boot-applications.tracing) for more details.
