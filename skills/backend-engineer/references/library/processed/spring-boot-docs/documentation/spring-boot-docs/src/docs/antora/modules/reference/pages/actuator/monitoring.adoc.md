...
> Upstream path: `documentation/spring-boot-docs/src/docs/antora/modules/reference/pages/actuator/monitoring.adoc`  
> Upstream Git blob: `aed5a2acf0e4ce120f661225f3352a9ff5f71414`  
...
NOTE: Jackson is a required dependency in order to get the correct JSON responses as documented in the [API documentation](api:rest/actuator/index.adoc).
