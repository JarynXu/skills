...
> Upstream path: `documentation/spring-boot-docs/src/docs/antora/modules/reference/pages/testing/testcontainers.adoc`  
> Upstream Git blob: `a0bb6cd9f07374461fc7de367524dbb249284406`  
...
TIP: This method of managing containers is often used in combination with [service connection annotations](#testing.testcontainers.service-connections).
