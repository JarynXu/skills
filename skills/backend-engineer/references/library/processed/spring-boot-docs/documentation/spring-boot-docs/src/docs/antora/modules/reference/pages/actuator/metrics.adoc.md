...
> Upstream path: `documentation/spring-boot-docs/src/docs/antora/modules/reference/pages/actuator/metrics.adoc`  
> Upstream Git blob: `e34188a17df82045830bcb5d3a97ffe4c2f54ee8`  
...
- [actuator/metrics.adoc#actuator.metrics.export.appoptics](actuator/metrics.adoc#actuator.metrics.export.appoptics)
- [actuator/metrics.adoc#actuator.metrics.export.atlas](actuator/metrics.adoc#actuator.metrics.export.atlas)
- [actuator/metrics.adoc#actuator.metrics.export.datadog](actuator/metrics.adoc#actuator.metrics.export.datadog)
- [actuator/metrics.adoc#actuator.metrics.export.dynatrace](actuator/metrics.adoc#actuator.metrics.export.dynatrace)
- [actuator/metrics.adoc#actuator.metrics.export.elastic](actuator/metrics.adoc#actuator.metrics.export.elastic)
- [actuator/metrics.adoc#actuator.metrics.export.ganglia](actuator/metrics.adoc#actuator.metrics.export.ganglia)
- [actuator/metrics.adoc#actuator.metrics.export.graphite](actuator/metrics.adoc#actuator.metrics.export.graphite)
- [actuator/metrics.adoc#actuator.metrics.export.humio](actuator/metrics.adoc#actuator.metrics.export.humio)
- [actuator/metrics.adoc#actuator.metrics.export.influx](actuator/metrics.adoc#actuator.metrics.export.influx)
- [actuator/metrics.adoc#actuator.metrics.export.jmx](actuator/metrics.adoc#actuator.metrics.export.jmx)
- [actuator/metrics.adoc#actuator.metrics.export.kairos](actuator/metrics.adoc#actuator.metrics.export.kairos)
- [actuator/metrics.adoc#actuator.metrics.export.newrelic](actuator/metrics.adoc#actuator.metrics.export.newrelic)
- [actuator/metrics.adoc#actuator.metrics.export.otlp](actuator/metrics.adoc#actuator.metrics.export.otlp)
- [actuator/metrics.adoc#actuator.metrics.export.prometheus](actuator/metrics.adoc#actuator.metrics.export.prometheus)
- [actuator/metrics.adoc#actuator.metrics.export.simple](actuator/metrics.adoc#actuator.metrics.export.simple) (in-memory)
- [actuator/metrics.adoc#actuator.metrics.export.stackdriver](actuator/metrics.adoc#actuator.metrics.export.stackdriver)
- [actuator/metrics.adoc#actuator.metrics.export.statsd](actuator/metrics.adoc#actuator.metrics.export.statsd)
...
Spring Boot also [configures built-in instrumentation](actuator/metrics.adoc#actuator.metrics.supported) that you can control through configuration or dedicated annotation markers.
...
If you use [Micrometer Tracing](actuator/tracing.adoc), this will be auto-configured for you.
...
TIP: By default, the endpoint is not available and must be exposed. See [exposing endpoints](actuator/endpoints.adoc#actuator.endpoints.exposing) for more details.
...
This lets you see what metrics are collected in the [metrics endpoint](actuator/metrics.adoc#actuator.metrics.endpoint).
...
Applications can opt in and record exceptions by [setting handled exceptions as request attributes](web/servlet.adoc#web.servlet.spring-mvc.error-handling).
...
Applications can opt in and record exceptions by [setting handled exceptions as request attributes](web/reactive.adoc#web.reactive.webflux.error-handling).
...
See [exposing endpoints](actuator/endpoints.adoc#actuator.endpoints.exposing) for more details.
