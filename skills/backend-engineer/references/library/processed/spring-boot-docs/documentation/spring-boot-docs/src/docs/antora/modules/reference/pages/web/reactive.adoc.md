...
> Upstream path: `documentation/spring-boot-docs/src/docs/antora/modules/reference/pages/web/reactive.adoc`  
> Upstream Git blob: `390f82507da79e748eb16e267c2c2bc65e6b43d9`  
...
* Configuring codecs for javadoc:org.springframework.http.codec.HttpMessageReader[] and javadoc:org.springframework.http.codec.HttpMessageWriter[] instances (described [later in this document](web/reactive.adoc#web.reactive.webflux.httpcodecs)).
* Support for serving static resources, including support for WebJars (described [later in this document](web/servlet.adoc#web.servlet.spring-mvc.static-content)).
...
You can also leverage [Boot's custom JSON serializers and deserializers](features/json.adoc#features.json.jackson.custom-serializers-and-deserializers).
...
You can also provide your own HTML templates to display errors (see the [next section](web/reactive.adoc#web.reactive.webflux.error-handling.error-pages)).
...
In some cases, errors handled at the controller level are not recorded by web observations or the [metrics infrastructure](actuator/metrics.adoc#actuator.metrics.supported.spring-webflux).
...
You can learn more about the resource configuration on the client side in the [io/rest-client.adoc#io.rest-client.webclient.runtime](io/rest-client.adoc#io.rest-client.webclient.runtime) section.
