...
> Upstream path: `documentation/spring-boot-docs/src/docs/antora/modules/reference/pages/security/saml2.adoc`  
> Upstream Git blob: `144a1240b9befe737d46af55987d1a555767951e`  
...
```gradle,subs="verbatim,attributes"
repositories {
