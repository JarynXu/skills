...
> Upstream path: `documentation/spring-boot-docs/src/docs/antora/modules/reference/pages/web/spring-session.adoc`  
> Upstream Git blob: `04f8530679f70ef517543a325f84231f36b0a8eb`  
...
To provide the timeout programmatically, define a javadoc:org.springframework.boot.session.autoconfigure.SessionTimeout[] bean.
