...
> Upstream path: `documentation/spring-boot-docs/src/docs/antora/modules/reference/pages/features/json.adoc`  
> Upstream Git blob: `58453d340445ad0e830a49d915876e3f1ecd2ffe`  
...
Several configuration properties are provided for [customizing the configuration of the javadoc:tools.jackson.databind.json.JsonMapper[](how-to:spring-mvc.adoc#howto.spring-mvc.customize-jackson-jsonmapper)].
