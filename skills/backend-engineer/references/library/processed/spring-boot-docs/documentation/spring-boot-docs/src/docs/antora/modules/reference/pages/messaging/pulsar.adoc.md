...
> Upstream path: `documentation/spring-boot-docs/src/docs/antora/modules/reference/pages/messaging/pulsar.adoc`  
> Upstream Git blob: `e518cb2e7433503d58d59751fd1721a10dc46a24`  
...
You can use the aforementioned [authentication configuration](messaging/pulsar.adoc#messaging.pulsar.connecting.auth) by replacing `spring.pulsar.client.authentication` with `spring.pulsar.admin.authentication`.
...
The properties supported by auto-configuration are shown in the [Integration Properties](appendix:application-properties/index.adoc#appendix.application-properties.integration) section of the Appendix.
