...
> Upstream path: `standard/delegates.md`  
> Upstream Git blob: `aacc8d64765ea566dfe4ff535425b1b930e2d153`  
...
> *Note*: An interesting and useful property of a delegate instance is that it does not know or care about the classes of the methods it encapsulates; all that matters is that those methods be compatible ([§21.4](delegates.md#214-delegate-compatibility)) with the delegate’s type. This makes delegates perfectly suited for “anonymous” invocation. *end note*
...
*unsafe_modifier* is defined in [§24.2](unsafe-code.md#242-unsafe-contexts).
...
The return type of a delegate type shall be either `void`, or output-safe ([§19.2.3.2](interfaces.md#19232-variance-safety)).

All the parameter types of a delegate type shall be input-safe ([§19.2.3.2](interfaces.md#19232-variance-safety)). In addition, any output or reference parameter types shall also be output-safe.
...
> For more examples of combining (as well as removing) delegates, see [§21.6](delegates.md#216-delegate-invocation).
>
> *end example*
