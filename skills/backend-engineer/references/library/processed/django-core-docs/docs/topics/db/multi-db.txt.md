...
> Upstream path: `docs/topics/db/multi-db.txt`  
> Upstream Git blob: `b5474ee9ebe513dca88667bd4b9cea893ee03023`  
...
the existence of an instance hint, and determines if that hint should be
...
:ref:`synchronizing_multiple_databases`, let's run some Django code:
