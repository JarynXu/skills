...
> Upstream path: `peps/pep-0008.rst`  
> Upstream Git blob: `d14c9e97b120daecadcd4afe742af69ddc07a34c`  
> Transform: `rst-to-html-to-markdown:docutils+markdownify`  
> This Markdown is generated for agent use. Consult `originals/` when exact upstream bytes matter.

PEP: 8
Title: Style Guide for Python Code
Author: Guido van Rossum <[guido@python.org](mailto:guido@python.org)>,

> Barry Warsaw <[barry@python.org](mailto:barry@python.org)>,
> Alyssa Coghlan <[ncoghlan@gmail.com](mailto:ncoghlan@gmail.com)>
...
Barry's style guide [[2]](#footnote-1).
...
braces, or using a *hanging indent* [[1]](#fn-hi). When using a hanging
...
displayed formulas always break before binary operations" [[3]](#footnote-2).
...
- CapitalizedWords (or CapWords, or CamelCase -- so named because
  of the bumpy look of its letters [[4]](#footnote-3)). This is also sometimes known
  as StudlyCaps.
...
- When implementing ordering operations with rich comparisons, it is
  ...
  with x <= y, and may swap the arguments of x == y and x != y. The sort() and min() operations are guaranteed to use
...
- Users who don't want to use type checkers are free to ignore them.
  ...
  the library author's permission) through the typeshed repo [[5]](#footnote-4).
