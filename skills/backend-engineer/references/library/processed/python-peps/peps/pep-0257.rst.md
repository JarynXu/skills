...
> Upstream path: `peps/pep-0257.rst`  
> Upstream Git blob: `9ef667588c3d57b35eb4eb32642b7e7acc6815c3`  
> Transform: `rst-to-html-to-markdown:docutils+markdownify`  
> This Markdown is generated for agent use. Consult `originals/` when exact upstream bytes matter.

PEP: 257
Title: Docstring Conventions
Author: David Goodger <[goodger@python.org](mailto:goodger@python.org)>,

> Guido van Rossum <[guido@python.org](mailto:guido@python.org)>

Discussions-To: [doc-sig@python.org](mailto:doc-sig@python.org)
Status: Active
Type: Informational
Created: 29-May-2001
...
looks. But some software (such as the [Docutils](https://docutils.sourceforge.io/) docstring processing
system [PEP 256](https://peps.python.org/pep-0256), [PEP 258](https://peps.python.org/pep-0258)) will be aware of the conventions, so following them
...
becomes the \_\_doc\_\_ special attribute of that object.

All modules should normally have docstrings, and all functions and
classes exported by a module should also have docstrings. Public
methods (including the \_\_init\_\_ constructor) should also have
docstrings. A package may be documented in the module docstring of
the \_\_init\_\_.py file in the package directory.
...
assigned to \_\_doc\_\_), but two types of extra docstrings may be
extracted by software tools:

1. String literals occurring immediately after a simple assignment at
   the top level of a module, class, or \_\_init\_\_ method are called
   "attribute docstrings".
2. String literals occurring immediately after another docstring are
   called "additional docstrings".

Please see [PEP 258](https://peps.python.org/pep-0258), "Docutils Design Specification", for a
...
package's \_\_init\_\_.py module) should also list the modules and
...
The "Specification" text comes mostly verbatim from [PEP 8](https://peps.python.org/pep-0008)
by Guido van Rossum.

This document borrows ideas from the archives of the Python [Doc-SIG](https://www.python.org/community/sigs/current/doc-sig/).
