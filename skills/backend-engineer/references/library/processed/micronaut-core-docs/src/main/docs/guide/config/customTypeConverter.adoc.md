...
> Upstream path: `src/main/docs/guide/config/customTypeConverter.adoc`  
> Upstream Git blob: `a31c9f190d9ab2a42554eb82f75caa851d2a2b83`  
...
The type `MyConfigurationProperties` has a property named `updatedAt` of type [LocalDate]({jdkapi}/java.base/java/time/LocalDate.html).
