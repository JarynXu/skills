...
> Upstream path: `src/main/docs/guide/httpServer/runningServer.adoc`  
> Upstream Git blob: `6237609b8e8fe44e4dba201652569763a0994bb9`  
...
To run the application from a unit test, use the [EmbeddedServer]({api}/io/micronaut/runtime/server/EmbeddedServer.html) interface:
