...
> Upstream path: `src/main/docs/guide/httpServer/filters/httpServerFilter/httpServerFilterExample.adoc`  
> Upstream Git blob: `abe38de566d2a961733eb8bac9d4f2c4dac4111f`  
