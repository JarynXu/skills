...
> Upstream path: `src/main/docs/guide/httpServer/filters/filterPatterns.adoc`  
> Upstream Git blob: `d3aaa285bfa1457ec0c3a2b6c8d163d341b73480`  
...
The other option is regular expression based matching. To use regular expressions, set `patternStyle = FilterPatternStyle.REGEX`. The `pattern` attribute is expected to contain a regular expression which will be expected to match the provided URLs exactly (using [Matcher#matches]({jdkapi}/java.base/java/util/regex/Matcher.html#matches--)).
