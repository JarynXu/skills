...
> Upstream path: `src/main/docs/guide/httpServer.adoc`  
> Upstream Git blob: `4b54755e91404d6aba0e24af6b129244ac58a43d`  
...
<1> The class is defined as a controller with the [@Controller]({api}/io/micronaut/http/annotation/Controller.html) annotation mapped to the path `/hello`
