...
> Upstream path: `src/main/docs/guide/httpServer/websocket/websocketClient.adoc`  
> Upstream Git blob: `5e579e43eaf7333a051a592ecd71a0519b25cbc0`  
...
The above example defines a send method that executes asynchronously and returns a [Future]({jdkapi}/java.base/java/util/concurrent/Future.html) to access the results.
