...
> Upstream path: `_content/doc/code.html`  
> Upstream Git blob: `b1f6aeebc3a188f96a4060de3a7ecf62ae09330c`  
...
module and introduces the [go tool](/cmd/go/), the standard way to
...
`https://golang.org/x/tools` (described more [here](/cmd/go/#hdr-Remote_import_paths)).
...
variables](/cmd/go/#hdr-Environment_variables). If `GOBIN` is set, binaries are installed to that
...
letter, it is [exported](/ref/spec#Exported_identifiers),
...
[testing package documentation](/pkg/testing/) for more detail.
...
See [Effective Go](/doc/effective_go.html) for tips on writing
...
[Go Nuts](https://groups.google.com/group/golang-nuts).

Report bugs using the
[Go issue tracker](/issue).
