...
> Source: `golang/website@b02076ae6df08ee9d495fe4b283f88ac18e51012`  
> Upstream path: `_content/doc/effective_go.html`  
> Upstream Git blob: `e13f48b061525e2d486024178fdb840d7461be6c`  
> Transform: `html-to-markdown:beautifulsoup+markdownify`  
> This Markdown is generated for agent use. Consult `originals/` when exact upstream bytes matter.

**Note:** This document was written for Go's release in 2009 and
...
or libraries added since. See [issue 28782](/issue/28782) for context.
For a complete list of changes,
see the [release notes](/doc/devel/release).
...
It augments the [language specification](/ref/spec),
the [Tour of Go](/tour/),
and [How to Write Go Code](/doc/code.html),
all of which you
should read first.

### Examples

The [Go package sources](/src/)
...
[this one](/pkg/strings/#example-Map) (if
...
For more about doc comments, see “[Go Doc Comments](/doc/comment)”.
...
See [the language specification](/ref/spec#Rune_literals)
for details.)
The loop
...
- In particular, if you pass an array to a function, it
  will receive a *copy* of the array, not a pointer to it.- The size of an array is part of its type. The types `[10]int`
...
you can use the [blank identifier](#blank) (`_`)
...
See the section below on [pointers vs. value receivers](#pointers_vs_values) for more information.)
...
[Type switches](#type_switch) are a form of conversion: they take an interface and, for
...
{{code "/doc/progs/eff\_unused1.go" `/package/` `$`}}
...
{{code "/doc/progs/eff\_unused2.go" `/package/` `$`}}
...
As we saw in the discussion of [interfaces](#interfaces_and_types) above,
...
The encoder checks this property at run time with a [type assertion](#interface_conversions) like:
...
See the [Go wiki](/wiki/LoopvarExperiment) for details.)
...
[this
blog post](/blog/concurrency-is-not-parallelism).
...
The second `if` statement here is another [type assertion](#interface_conversions).
...
{{code "/doc/progs/eff\_qr.go" `/package/` `$`}}
...
If this is too quick an explanation, see the [documentation](/pkg/html/template/)
