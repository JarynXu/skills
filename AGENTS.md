...
- Initialize new skills with the installed skill creator, validate them with `scripts/validate_repository.py`, test their scripts, and verify repository discovery with `npx skills add . --list`.
